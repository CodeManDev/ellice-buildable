...
public final class MenuLoaderTracker implements AutoCloseable {
  ...
  private final ConcurrentLinkedQueue<MenuLoaderTracker.Result> concurrentLinkedQueue =
            ...
            try {
              List items =
                  this.loader.load().stream()
                      .sorted(
                          Comparator.comparingLong(MenuLoaderTracker.World::lastPlayed)
                              .reversed()
              ...
              this.concurrentLinkedQueue.add(
                  new MenuLoaderTracker.Result(
                      null, "Could not read your worlds. Check the saves folder and try again."));
            }
          });
    }
  }
