...
public final class ToolChooseService {
          ...
          && (candidate == null
              ...
              || currentCandidate.harvests == candidate.harvests
                  && (currentCandidate.progress > candidate.progress + 1.0E-7F
                      || Math.abs(currentCandidate.progress - candidate.progress) <= 1.0E-7F
                          && currentCandidate.slot == value))) {
  ...
  public record Candidate(
      int slot, boolean harvests, float progress, int durability, boolean damageable) {}
}
