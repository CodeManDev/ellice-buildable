...
public final class TravelFallCostService {
  ...
  public static final double WALK_DIAGONAL = 4.63284688441047 * Math.sqrt(2.0);
  public static final double SPRINT_DIAGONAL = 3.563791874554526 * Math.sqrt(2.0);
  ...
  public static double fallCost(double doubleValue) {
    return doubleValue <= 0.0 ? 0.0 : Math.sqrt(2.0 * doubleValue / 0.08) + 2.0;
  }
