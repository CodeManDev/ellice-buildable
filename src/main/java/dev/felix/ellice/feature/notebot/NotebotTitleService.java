...
public final class NotebotTitleService {
  ...
  public NotebotTitleService(
      String currentText, int value, List<NotebotTitleService.Note> currentItems, float[] floats) {
        ...
        currentItems.stream()
            ...
            .sorted(
                Comparator.comparingInt(NotebotTitleService.Note::tick)
                    .thenComparing(
                        Comparator.comparingDouble(NotebotTitleService.Note::strength).reversed()))
            .toList();
