...
public enum StudioMode {
  ...
  MULTIPLY(
      "Multiply", "Math", StudioMode.Type.NUMBER, createPort("A", 1.0F), createPort("B", 1.0F)),
  ...
  WAVE(
      "Sine wave",
      "Motion",
      StudioMode.Type.NUMBER,
      createPort("Time", 0.0F),
      createPort("Speed", 1.0F)),
  ...
  CAPTION(
      ...
      "Output",
      null,
      new StudioMode.Port("Value", StudioMode.Type.TEXT, 0.0F),
      createPort2("When")),
  ...
  StudioMode(
      String text, String currentText, StudioMode.Type type, StudioMode.Port... currentPorts) {
    this.title = text;
