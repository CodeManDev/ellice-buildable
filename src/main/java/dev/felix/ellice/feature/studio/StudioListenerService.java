...
public final class StudioListenerService {
    ...
    private String ffc62y9i8v0n;
    private String f35jsgi7i4t8;
    ...
    private final Deque<String> fgnjpfi0gyz4 = new ArrayDeque();
    private Runnable fdrjl6obaz0l = () -> {
    };

    public StudioListenerService(StudioShapeService studioShapeService) {
        this.project = studioShapeService.copy();
        this.f35jsgi7i4t8 = this.project.snapshot();
    }

    public void listener(Runnable runnable) {
        this.fdrjl6obaz0l = runnable;
    }

    public void notifyChanged() {
        this.fdrjl6obaz0l.run();
    }

    public boolean dirty() {
        return !this.f35jsgi7i4t8.equals(this.project.snapshot());
    }
    ...
    public void beginGesture() {
        if (this.ffc62y9i8v0n == null) {
            this.ffc62y9i8v0n = this.project.snapshot();
        }
    }

    public boolean gestureActive() {
        return this.ffc62y9i8v0n != null;
    }

    public void endGesture() {
        if (this.ffc62y9i8v0n != null && !this.ffc62y9i8v0n.equals(this.project.snapshot())) {
            this.fdamkadde8lx.push(this.ffc62y9i8v0n);
            while (this.fdamkadde8lx.size() > 48) {
                this.fdamkadde8lx.removeLast();
            }
            this.fgnjpfi0gyz4.clear();
        }
        this.ffc62y9i8v0n = null;
        this.fdrjl6obaz0l.run();
    }

    public void cancelGesture() {
        if (this.ffc62y9i8v0n != null) {
            this.project = StudioShapeService.restore(this.ffc62y9i8v0n);
        }
        this.ffc62y9i8v0n = null;
        this.fdrjl6obaz0l.run();
    }
    ...
    public boolean canRedo() {
        return !this.fgnjpfi0gyz4.isEmpty();
    }
    ...
    public void undo() {
        ...
        this.fgnjpfi0gyz4.push(this.project.snapshot());
    ...
    public void redo() {
        if (this.fgnjpfi0gyz4.isEmpty()) {
            return;
        }
        this.fdamkadde8lx.push(this.project.snapshot());
        this.project = StudioShapeService.restore(this.fgnjpfi0gyz4.pop());
        this.selected = "";
        this.message = "Redone";
        this.fdrjl6obaz0l.run();
    }
    ...
    public void addShape(StudioShapeService.ShapeKind shapeKind, float f, float f2) {
        if (this.project.shapes.size() < 64) {
            edit(studioShapeService -> {
                StudioShapeService.Shape shape = StudioOrbitService.shape(studioShapeService, shapeKind, title(shapeKind), StudioValidateValidator.clamp(grid(f), Float.intBitsToFloat(-981860352), Float.intBitsToFloat(1165623296)), StudioValidateValidator.clamp(grid(f2), Float.intBitsToFloat(-981860352), Float.intBitsToFloat(1165623296)), shapeKind == StudioShapeService.ShapeKind.TEXT ? Float.intBitsToFloat(1127481344) : Float.intBitsToFloat(1120403456), shapeKind == StudioShapeService.ShapeKind.TEXT ? Float.intBitsToFloat(1108344832) : Float.intBitsToFloat(1120403456), -4213519);
    ...
    public void addBlock(StudioMode studioMode, float f, float f2) {
        if (this.project.blocks.size() < 96) {
            edit(studioShapeService -> {
                StudioShapeService.Block block = StudioOrbitService.block(studioShapeService, studioMode, StudioValidateValidator.clamp(grid(f), Float.intBitsToFloat(-969179136), Float.intBitsToFloat(1178304512)), StudioValidateValidator.clamp(grid(f2), Float.intBitsToFloat(-969179136), Float.intBitsToFloat(1178304512)));
    ...
    public void connect(String str, String str2, String str3) {
        String strConnectionError = StudioValidateValidator.connectionError(this.project, str, str2, str3);
        ...
        if (shape == null || !shape.locked) {
            edit(studioShapeService -> {
                ...
                if (shape != null) {
                    ...
                    studioShapeService.shapes.removeIf(shape3 -> {
                        return hashSet.contains(shape3.id);
                    });
                    studioShapeService.blocks.removeIf(block2 -> {
                    ...
                    while (it.hasNext()) {
                        ...
                        collectionValues.removeIf(inputId -> {
    ...
    public void duplicate() {
        ...
        if (shape == null || this.project.shapes.size() >= 64) {
            ...
            edit(studioShapeService -> {
                ...
                block2.x = StudioValidateValidator.clamp(block2.x + Float.intBitsToFloat(1107296256), Float.intBitsToFloat(-969179136), Float.intBitsToFloat(1178304512));
                block2.y = StudioValidateValidator.clamp(block2.y + Float.intBitsToFloat(1107296256), Float.intBitsToFloat(-969179136), Float.intBitsToFloat(1178304512));
        ...
        List<StudioShapeService.Block> list = this.project.blocks.stream().filter(block2 -> {
            return block2.kind.shapeOutput() && linkedHashSet.contains(block2.target);
        }).toList();
        if (this.project.shapes.size() + linkedHashSet.size() <= 64 && this.project.blocks.size() + list.size() <= 96) {
            edit(studioShapeService2 -> {
                ...
                for (StudioShapeService.Shape shape3 : studioShapeServiceCopy.shapes) {
                    if (linkedHashSet.contains(shape3.id)) {
                        ...
                        if (zEquals) {
                            shape3.name = m45t277aoo8m(shape.name + " copy", 48);
                            shape3.x = StudioValidateValidator.clamp(shape3.x + Float.intBitsToFloat(1098907648), Float.intBitsToFloat(-981860352), Float.intBitsToFloat(1165623296));
                            shape3.y = StudioValidateValidator.clamp(shape3.y + Float.intBitsToFloat(1098907648), Float.intBitsToFloat(-981860352), Float.intBitsToFloat(1165623296));
                        }
                ...
                for (StudioShapeService.Block block3 : studioShapeServiceCopy.blocks) {
                    if (block3.kind.shapeOutput() && linkedHashSet.contains(block3.target)) {
                        ...
                        block3.y = StudioValidateValidator.clamp(block3.y + Float.intBitsToFloat(1107296256), Float.intBitsToFloat(-969179136), Float.intBitsToFloat(1178304512));
    ...
    private static String m45t277aoo8m(String str, int i) {
