...
public final class StudioOrbitService {
   ...
   public static StudioShapeService orbit() {
      ...
      StudioShapeService.Shape currentShape = shape(
         studioShape,
      ...
      StudioShapeService.Shape nextShape = shape(
         studioShape,
      ...
      StudioShapeService.Shape previousShape = shape(
         studioShape,
      ...
      StudioShapeService.Shape sourceShape = shape(
         studioShape,
         StudioShapeService.ShapeKind.TEXT,
         "Title",
         196.0F,
      ...
      StudioShapeService.Shape targetShape = shape(
         studioShape,
         StudioShapeService.ShapeKind.TEXT,
         "Player",
         196.0F,
      ...
      StudioShapeService.Shape inputShape = shape(
         studioShape,
         StudioShapeService.ShapeKind.TEXT,
         "Caption",
         196.0F,
   ...
   public static StudioShapeService.Shape shape(
      StudioShapeService studioShape, StudioShapeService.ShapeKind shapeKind, String text, float value, float currentValue, float nextValue, float previousValue, int sourceValue
   ) {
   ...
   public static StudioShapeService.Block block(StudioShapeService studioShape, StudioMode studioMode, float value, float currentValue) {
