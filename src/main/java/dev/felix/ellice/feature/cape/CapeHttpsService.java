...
public final class CapeHttpsService {
   ...
   public static byte[] get(URI uRI, int value) throws IOException {
      HttpRequest httpRequest = HttpRequest.newBuilder(uRI)
         ...
         .GET()
         .build();
      CompletableFuture completableFuture = client.sendAsync(httpRequest, item -> new CapeHttpsService.LimitedBody(value));
      ...
      try {
         ...
         completableFuture.cancel(true);
         throw new IOException("The download failed or timed out. Try again.", executionExceptionTimeoutException);
      }
   }
