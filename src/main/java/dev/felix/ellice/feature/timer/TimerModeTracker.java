...
public final class TimerModeTracker {
  ...
  public void tick() {
    ...
    switch (this.f43qlikq47o6.mode().ordinal()) {
      ...
      case 3:
        {
          this.f9y13mtnhovd =
              (this.f1fs0sb8nmwy ? this.f43qlikq47o6.boostSpeed() : this.f43qlikq47o6.brakeSpeed());
          break;
        }
    }
  }
  ...
  private void m8fu3t44yzog() {
    if (++this.f4tyr43mtfx3
        >= (this.f1fs0sb8nmwy ? this.f43qlikq47o6.boostTicks() : this.f43qlikq47o6.brakeTicks())) {
      this.f4tyr43mtfx3 = 0;
      this.f1fs0sb8nmwy = !this.f1fs0sb8nmwy;
    }
    this.f9y13mtnhovd =
  ...
  private float mgio3v7k2zdd() {
    return this.f43qlikq47o6.randomMinimum()
        + this.f4ilwrf7tp8p.nextFloat()
            * (this.f43qlikq47o6.randomMaximum() - this.f43qlikq47o6.randomMinimum());
  }
  ...
  public record Profile(
    ...
    public Profile {
      if (mode == null
          || !m7t9f6eg9npb(constantSpeed)
          || !m7t9f6eg9npb(boostSpeed)
          || !m7t9f6eg9npb(brakeSpeed)
          || !m7t9f6eg9npb(randomMinimum)
          || !m7t9f6eg9npb(randomMaximum)
