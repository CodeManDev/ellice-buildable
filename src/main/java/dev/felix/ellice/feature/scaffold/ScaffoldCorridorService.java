...
public final class ScaffoldCorridorService {
  ...
  public static List<ScaffoldCorridorService.EyeSample> corridor(
      RotationVector var0, RotationVector var1, RotationVector var2, int var3) {
    ...
    if (var3 >= 0 && var3 <= 8) {
      ...
      var4.add(
          new ScaffoldCorridorService.EyeSample(
              ScaffoldCorridorService.Phase.PREVIOUS_WIRE_EYE, var0));
      var4.add(
          new ScaffoldCorridorService.EyeSample(
              ScaffoldCorridorService.Phase.CLIENT_PRE_USE_EYE, var1));
      ...
      for (int var6 = 1; var6 <= var3; var6++) {
        ...
        var4.add(
            new ScaffoldCorridorService.EyeSample(
                ScaffoldCorridorService.Phase.MOVEMENT_CORRIDOR, var1.add(var5.multiply(var7))));
      }

      var4.add(
          new ScaffoldCorridorService.EyeSample(
              ScaffoldCorridorService.Phase.FOLLOWING_WIRE_EYE, var2));
  ...
  public static ScaffoldCorridorService.Evaluation evaluate(
      PlacementCandidate var0,
      RotationData var1,
      double var2,
      List<ScaffoldCorridorService.EyeSample> var4,
      ScaffoldCorridorService.Probe var5) {
    ...
    double var6 = calculateValue(var2);
    byte var8 = 0;
    byte var9 = 0;
    ...
    return var8 != 0 && var9 != 0
        ...
        : new ScaffoldCorridorService.Evaluation(
            false, ScaffoldCorridorService.Failure.MISSING_WIRE_ENDPOINT, var6, 0.0, List.of());
  }
  ...
  public static ScaffoldCorridorService.Preflight evaluateBeforePhysics(
      ...
      RotationVector var4,
      RotationVector var5,
      ScaffoldCorridorService.Probe var6) {
    Objects.requireNonNull(var0, "intended");
    Objects.requireNonNull(var1, "wireRotation");
    ...
    List var7 =
        List.of(
            new ScaffoldCorridorService.EyeSample(
                ScaffoldCorridorService.Phase.PREVIOUS_WIRE_EYE, var4),
            new ScaffoldCorridorService.EyeSample(
                ScaffoldCorridorService.Phase.CLIENT_PRE_USE_EYE, var5));
    ScaffoldCorridorService.Evaluation var8 =
        mgvuyvuryyac(var0, var1, calculateValue(var2), var7, var6);
    return new ScaffoldCorridorService.Preflight(
        var8.ready(),
        var8.firstFailure(),
        var8.requiredMargin(),
        var8.narrowestMargin(),
        var8.samples());
  }
  ...
  private static ScaffoldCorridorService.Evaluation mgvuyvuryyac(
    ...
    for (ScaffoldCorridorService.EyeSample var12 : var4) {
      Optional<ScaffoldBlockHit> var13 =
          var6.computeIfAbsent(
              var12.eye(),
              var2x ->
                  Objects.requireNonNull(
                      var5.raycast(var2x, var1), "Rotation-place probe returned null"));
      ScaffoldCorridorService.SampleResult var14 = createSampleResult(var0, var12, var13, var2);
      var7.add(var14);
      if (var14.usable()) {
    ...
    return new ScaffoldCorridorService.Evaluation(
        (var15 != 0), var8, var2, var15 != 0 ? var9 : 0.0, var7);
  }

  private static double calculateValue(double var0) {
    if (Double.isFinite(var0)
        && !(var0 < 0.0)
        && !(var0 > Double.longBitsToDouble(4602678819172646912L))) {
  ...
  private static ScaffoldCorridorService.SampleResult createSampleResult(
      PlacementCandidate var0,
      ScaffoldCorridorService.EyeSample var1,
      Optional<ScaffoldBlockHit> var2,
      double var3) {
    if (var2.isEmpty()) {
      return new ScaffoldCorridorService.SampleResult(
          var1, ScaffoldCorridorService.Failure.RAY_MISS, 0.0);
    } else {
      ScaffoldBlockHit var5 = (ScaffoldBlockHit) var2.get();
      if (!var0.supportPosition().equals(var5.blockPosition())) {
        return new ScaffoldCorridorService.SampleResult(
            var1, ScaffoldCorridorService.Failure.WRONG_SUPPORT_FACE, 0.0);
      } else if (var1.phase() == ScaffoldCorridorService.Phase.FOLLOWING_WIRE_EYE
          && var0.clickedFace() != var5.face()) {
        return new ScaffoldCorridorService.SampleResult(
            var1, ScaffoldCorridorService.Failure.WRONG_SUPPORT_FACE, 0.0);
      } else {
        ...
        if (var5.inside()) {
          return new ScaffoldCorridorService.SampleResult(
              var1, ScaffoldCorridorService.Failure.INSIDE_SUPPORT, var6);
        } else {
          return var6 < var3
              ? new ScaffoldCorridorService.SampleResult(
                  var1, ScaffoldCorridorService.Failure.EDGE_MARGIN, var6)
              : new ScaffoldCorridorService.SampleResult(
                  var1, ScaffoldCorridorService.Failure.NONE, var6);
        }
      }
    }
  }
  ...
  public record SampleResult(
      ScaffoldCorridorService.EyeSample sample,
      ScaffoldCorridorService.Failure failure,
      double edgeMargin) {
    public SampleResult(
        ScaffoldCorridorService.EyeSample sample,
        ScaffoldCorridorService.Failure failure,
      ...
      if (Double.isFinite(edgeMargin)
          && !(edgeMargin < 0.0)
          && !(edgeMargin > Double.longBitsToDouble(4602678819172646912L))) {
        this.sample = sample;
