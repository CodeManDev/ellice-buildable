...
public final class LocalPhysicsFrameBus {
  ...
  public static boolean publishAppliedInput(
      long longValue, ScaffoldRemapService.Input currentInput, boolean enabled) {
  ...
  public record Frame(
      long tick, float yaw, ScaffoldRemapService.Input input, boolean suppressSprint) {
    ...
    public LocalPhysicsFrameBus.Frame withAppliedInput(
        ScaffoldRemapService.Input input, boolean enabled) {
