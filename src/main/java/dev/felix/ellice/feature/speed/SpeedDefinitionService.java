...
public final class SpeedDefinitionService {
  ...
  public static SpeedDefinitionService.Definition get(String text) {
    return ALL.stream()
        .filter(item -> item.id().equals(text))
        .findFirst()
  ...
  private static List<SpeedDefinitionService.Definition> collectValues() {
    ...
    updateState(
        ...
        SpeedDefinitionService.Option.num("Horizontal acceleration", 0.0, -0.1, 0.2),
        ...
        SpeedDefinitionService.Option.num("Jump height", 0.42, 0.0, 3.0),
        ...
        SpeedDefinitionService.Option.num("Timer speed", 1.0, 0.1, 10.0));
    updateState(
        arrayList,
        "YPort",
        "General",
    ...
    updateState(
        ...
        "VerusB3882",
        "Verus",
        "Jump boost, full movement strafe and periodic timer pulses.");
    updateState(
        arrayList,
        "HypixelBHop",
        "Watchdog",
    ...
    updateState(
        ...
        "HypixelLowHop",
        "Watchdog",
        "Air-tick low hops with ground proximity strafe.",
        SpeedDefinitionService.Option.flag("Glide", false));
    updateState(
        arrayList,
        "Spartan-4.0.4.3",
        "Spartan",
        "Ground move boost and repeated sprint jumps; leather boots affect the boost.");
    updateState(
        arrayList,
        "Spartan-4.0.4.3-FastFall",
        "Spartan",
        "Repeated jumps followed by a ground packet and downward move.");
    updateState(
        arrayList,
        "SentinelDamage",
        "Sentinel",
        "Periodic fall-damage packets and movement after damage.",
        SpeedDefinitionService.Option.num("Speed", 0.5, 0.1, 5.0),
        SpeedDefinitionService.Option.count("Reboost ticks", 30, 10, 50),
        SpeedDefinitionService.Option.count("Ping delay", 500, 0, 25000));
    updateState(
        arrayList, "Vulcan286", "Vulcan", "Six-tick strafe and fast-fall sequence after jumping.");
    updateState(
        arrayList,
        "Vulcan288",
        "Vulcan",
        "Potion-dependent four-tick speed sequence and ground packets while descending.");
    updateState(
        arrayList, "VulcanGround286", "Vulcan", "Small ground hops with a position packet offset.");
    updateState(
        arrayList,
        "GrimCollide",
        "Grim",
        "Add forward motion for nearby living entities.",
        SpeedDefinitionService.Option.num("Boost speed", 0.08, 0.01, 0.08),
        SpeedDefinitionService.Option.num("Shrink box", 0.5, 0.1, 2.0));
    updateState(
        arrayList,
        "NCP",
        "NCP",
        ...
        SpeedDefinitionService.Option.num("Motion multiplier", 1.0, 0.01, 10.0),
        ...
        SpeedDefinitionService.Option.num("Initial boost multiplier", 1.0, 0.01, 10.0),
    ...
    updateState(
        ...
        SpeedDefinitionService.Option.flag("Strafe", true),
        SpeedDefinitionService.Option.num("Strafe strength", 0.27, 0.01, 0.27),
    ...
    updateState(
        ...
        SpeedDefinitionService.Option.flag("Timer", true));
    updateState(
        arrayList, "HylexLowHop", "Hylex", "Low jump height and small speed-dependent air boosts.");
    updateState(
        arrayList,
        "HylexGround",
        "Hylex",
        "Ground acceleration after five uninterrupted grounded ticks.");
    updateState(
        arrayList,
        "BlocksMC",
        "BlocksMC",
    ...
    updateState(
        arrayList, "Matrix7", "Matrix", "Fixed jump motion and strafe at low horizontal speed.");
    updateState2(
        arrayList, "NCPBHop", "NCP", true, "Staged bunny hops with a five-move timer cycle.");
    ...
    updateState2(
        ...
        "NCP",
        true,
        "Staged bunny hops with a collision recovery sequence.");
    ...
    updateState2(
        arrayList, "UNCPHop", "NCP", false, "Potion-dependent speed decay and alternating timer.");
    updateState2(
        arrayList,
        "UNCPHopNew",
        "NCP",
    ...
    updateState2(
        ...
        "AAC",
        true,
        "Initial forward jump boost and fall-dependent air acceleration.");
    ...
    updateState2(
        arrayList, "AACHop5", "AAC", false, "Bunny hops with periodic fall-distance timer boosts.");
    updateState2(
        arrayList,
        "SpartanYPort",
        "Spartan",
        false,
        "Forward hops with alternating randomized pull down.");
    updateState2(
        arrayList,
        "SpectreLowHop",
        "Spectre",
        true,
        "Low vertical motion and fixed ground strafe.");
    updateState2(
        arrayList, "SpectreBHop", "Spectre", true, "High ground strafe followed by air strafe.");
    updateState2(
        arrayList, "SpectreOnGround", "Spectre", true, "Ten ground boosts followed by a stop.");
    updateState2(
        arrayList, "VerusHop", "Verus", false, "Potion-dependent bunny hop speed with air decay.");
    updateState2(
        arrayList,
        "VerusFHop",
        "Verus",
        false,
        "Different straight and diagonal ground/air speeds.");
    updateState2(
        arrayList,
        "VerusLowHop",
        "Verus",
        true,
        "Potion-dependent low hops with immediate pull down.");
    updateState2(
        arrayList,
        "VerusLowHopNew",
        "Verus",
        false,
        "Low hops with slowness-aware speed and air decay.");
    updateState2(
        arrayList,
        "VulcanHop",
        "Vulcan",
        false,
        "Ground strafe with ascent and descent timer stages.");
    updateState2(
        arrayList, "VulcanLowHop", "Vulcan", false, "Tick-dependent low hops and timer stages.");
    updateState2(
        arrayList,
        "VulcanGround2.8.8",
        "Vulcan",
        false,
        "Ground collision strafe, jump suppression and position offset.");
    updateState2(
        arrayList, "OldMatrixHop", "Matrix", true, "Bunny hops with air acceleration and strafe.");
    ...
    for (String text : List.of("MatrixHop", "MatrixSlowHop")) {
      updateState2(
          ...
          SpeedDefinitionService.Option.flag("Low hop", true),
          SpeedDefinitionService.Option.num("Extra ground boost", 0.2, 0.0, 0.5));
    }
    ...
    updateState2(
        ...
        SpeedDefinitionService.Option.num("Initial boost multiplier", 1.0, 0.01, 10.0),
        SpeedDefinitionService.Option.flag("Low hop", true),
        SpeedDefinitionService.Option.num("Strafe strength", 0.29, 0.1, 0.29),
        SpeedDefinitionService.Option.num("Ground timer", 0.5, 0.1, 5.0),
        SpeedDefinitionService.Option.num("Air timer", 1.09, 0.1, 5.0));
    updateState2(
        arrayList,
        "TeleportCubeCraft",
        "CubeCraft",
        ...
        SpeedDefinitionService.Option.num("Port length", 1.0, 0.1, 2.0));
    updateState2(
        arrayList,
        "HypixelHop",
        "Watchdog",
        false,
        "Strafe-phase jumps with a ground speed boost.");
    updateState2(
        arrayList,
        "HypixelLowHop",
        "Watchdog",
    ...
    updateState2(
        ...
        "NCP",
        false,
        "Ground acceleration cycle with collision-checked position offsets.");
    updateState2(
        arrayList,
        "Frame",
        "NCP",
        true,
        "Alternating jump cycles with a delayed horizontal boost.");
    updateState2(
        arrayList,
        "MiJump",
        "NCP",
        true,
        "Small ground jumps with capped horizontal acceleration.");
    updateState2(
        arrayList,
        "OnGround",
        "NCP",
        false,
        "Ground position and motion sequence with timer boost.");
    updateState2(
        arrayList, "SlowHop", "General", false, "Bunny hops with gradual air acceleration.");
    ...
    updateState2(
        ...
        SpeedDefinitionService.Option.num("Jump height", 0.42, 0.0, 4.0),
        SpeedDefinitionService.Option.num("Ground strafe", 1.6, 0.0, 2.0),
        SpeedDefinitionService.Option.num("Air strafe", 0.0, 0.0, 2.0),
        SpeedDefinitionService.Option.num("Ground timer", 1.0, 0.1, 2.0),
        SpeedDefinitionService.Option.count("Air timer tick", 5, 1, 20),
        SpeedDefinitionService.Option.num("Air timer", 1.0, 0.1, 2.0),
    ...
    arrayList.addAll(
        SpeedSourceService.SOURCES.stream().map(SpeedSourceService.Source::definition).toList());
    return List.copyOf(arrayList);
  }

  private static void updateState(
      List<SpeedDefinitionService.Definition> items,
      String text,
      String currentText,
      String nextText,
    ...
    items.add(
        new SpeedDefinitionService.Definition(
            "nextgen/" + text, text, "Nextgen", currentText, nextText, false, List.of(options)));
  }
  ...
  private static void updateState2(
    ...
    items.add(
        new SpeedDefinitionService.Definition(
            "legacy/" + text, text, "Legacy", currentText, nextText, enabled, List.of(options)));
  }
  ...
  public record Definition(
      ...
      String description,
      boolean deprecated,
      List<SpeedDefinitionService.Option> options) {
    public ModuleEntriesService.Entry entry() {
      return new ModuleEntriesService.Entry(
          this.id, this.name, this.edition, this.group, this.description, this.deprecated);
    }
    ...
    public SpeedStrafeHandler create(SpeedOperationHandler speedOperation) {
      ...
      if (currentSource != null) {
        ...
        return this.edition.equals("Nextgen")
            ...
            : (this.group.equals("NCP")
                ? new NcpSpeedMode(this.name, speedOperation)
                : new LegacySpeedMode(this.name, speedOperation));
      }
    }
  }

  public record Option(
      String key, Object value, double min, double max, double step, List<String> choices) {
    ...
    static SpeedDefinitionService.Option num(
        String text, double doubleValue, double currentDoubleValue, double nextDoubleValue) {
      return new SpeedDefinitionService.Option(
          text, doubleValue, currentDoubleValue, nextDoubleValue, 0.001, List.of());
    }

    static SpeedDefinitionService.Option count(
        String text, int value, int currentValue, int nextValue) {
      return new SpeedDefinitionService.Option(
          text, (double) value, currentValue, nextValue, 1.0, List.of());
    }

    static SpeedDefinitionService.Option choice(
        String text, String currentText, String... strings) {
