...
public final class SpeedSourceService {
   ...
   public static SpeedSourceService.Source source(String text) {
      return SOURCES.stream().filter(item -> item.definition.id().equals(text)).findFirst().orElse(null);
   }
   ...
   private static List<SpeedSourceService.Source> collectValues() {
      ...
      updateState(
         arrayList, SpeedSourceService.Client.ATANI, "Karhu", "Karhu", "Karhu", "55-percent jump height with a small randomized air timer.", ""
      );
      updateState(
         arrayList,
         SpeedSourceService.Client.ATANI,
      ...
      updateState(
         arrayList, SpeedSourceService.Client.ETB, "Bhop", "Bhop", "NCP", "Three-stage bunny hops, 2.1 launch multiplier and a 1.07 timer.", ""
      );
      updateState(
         arrayList,
   ...
   private static SpeedDefinitionService.Option createOption(String text, double doubleValue, double currentDoubleValue, double nextDoubleValue, double previousDoubleValue) {
      return new SpeedDefinitionService.Option(text, doubleValue, currentDoubleValue, nextDoubleValue, previousDoubleValue, List.of());
   }
   ...
   private static void updateState(
      ...
      SpeedDefinitionService.Definition definition = new SpeedDefinitionService.Definition(
         client.namespace + "/" + text, currentText, client.edition, nextText, previousText, true, List.of(options)
      );
   ...
   public enum Client {
      ...
      ATANI("atani-0.0.3", "Atani 0.0.3", "tech/atani/client/feature/module/impl/movement/Speed.java"),
      EXHIBITION("exhibition-081618", "Exhibition 081618", "exhibition/module/impl/movement/Speed.java"),
   ...
   public record Source(SpeedSourceService.Client client, String mode, String file, SpeedDefinitionService.Definition definition) {
      public String url() {
         try {
            return new URI(
                  "https",
