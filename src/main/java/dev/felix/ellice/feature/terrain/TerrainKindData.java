...
public record TerrainKindData(
   UUID id, String name, String dimension, double x, double y, double z, int color, TerrainKindData.Kind kind, long createdAt
) {
   public TerrainKindData(UUID uUID, String text, String currentText, double doubleValue, double currentDoubleValue, double nextDoubleValue, int value) {
      this(uUID, text, currentText, doubleValue, currentDoubleValue, nextDoubleValue, value, TerrainKindData.Kind.PLACE, System.currentTimeMillis());
   }
   ...
   public TerrainKindData renamed(String name) {
      return new TerrainKindData(this.id, name, this.dimension, this.x, this.y, this.z, this.color, this.kind, this.createdAt);
   }

   public TerrainKindData movedTo(double doubleValue, double currentDoubleValue, double nextDoubleValue) {
      return new TerrainKindData(this.id, this.name, this.dimension, doubleValue, currentDoubleValue, nextDoubleValue, this.color, this.kind, this.createdAt);
   }

   public TerrainKindData withKind(TerrainKindData.Kind currentKind) {
      return currentKind == this.kind
         ? this
         : new TerrainKindData(this.id, this.name, this.dimension, this.x, this.y, this.z, currentKind.color(), currentKind, this.createdAt);
   }
