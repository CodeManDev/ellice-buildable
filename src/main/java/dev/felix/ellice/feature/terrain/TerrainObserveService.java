...
public final class TerrainObserveService {
  ...
  public TerrainKindData observe(
      CompatLoadedHandler.World world, boolean enabled, boolean currentEnabled, long longValue) {
    return this.observe(
        world, world == null ? null : world.identity(), enabled, currentEnabled, longValue);
  }
