...
public final class RotationObserveService {
  ...
  public static synchronized void observe(ServerboundMovePlayerPacket serverboundMovePlayerPacket) {
    ...
    observe(
        serverboundMovePlayerPacket, rotationVector, rotationVector, new RotationData(0.0, 0.0));
  }
  ...
  public static synchronized void observe(
    ...
    if (serverboundMovePlayerPacket != null
      ...
      rotationData73 =
          nextRotationVector != null && rotationData7 != null
              ? rotationData7.subtract(nextRotationVector)
              : null;
      enabled = true;
    ...
    if (Boolean.getBoolean("ellice.combat.trace")) {
      LoggerFactory.getLogger("CombatTrace")
          .info(
              ...
              new Object[] {
                System.nanoTime(), text, CombatOwnsService.currentOwner().orElse(null), snapshot2
              });
    }
  }
  ...
  private static void updateState2() {
    if (rotationData != null && rotationData7 != null && rotationData72 != null) {
      snapshot2 =
          new RotationObserveService.Snapshot(
              timestamp,
              rotationData,
              rotationData7,
              rotationData7.add(rotationData72),
              enabled3,
              enabled4);
    } else {
      snapshot2 = null;
  ...
  public static synchronized Optional<RotationVector> inheritedVelocity() {
    return Optional.ofNullable(rotationData73)
        .map(item -> new RotationVector(item.x(), enabled2 ? 0.0 : item.y(), item.z()));
  }
  ...
  public record Snapshot(
    ...
    public Snapshot(
      ...
      if (ordinal >= 1L
          && rotation != null
          && wireFeetPosition != null
          && wireEyePosition != null) {
