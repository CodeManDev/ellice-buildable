...
public record RotationHumanizationProfile(
   ...
   public RotationHumanizationProfile(double doubleValue, double currentDoubleValue, double nextDoubleValue, boolean enabled, boolean currentEnabled, boolean nextEnabled, boolean previousEnabled, double previousDoubleValue) {
      this(
         doubleValue,
         currentDoubleValue,
         nextDoubleValue,
   ...
   public RotationHumanizationProfile(
      ...
      if (Double.isFinite(overshootMinDegrees)
         ...
         if (reactionMinTicks >= 0 && reactionMaxTicks >= 0 && reactionMinTicks <= 20 && reactionMaxTicks <= 20) {
