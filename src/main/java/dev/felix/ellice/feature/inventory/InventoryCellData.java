...
public record InventoryCellData(Object menu, List<InventoryCellData.Cell> cells, boolean paused, boolean cursorEmpty) {
   public InventoryCellData(Object menu, List<InventoryCellData.Cell> cells, boolean paused, boolean cursorEmpty) {
