...
public final class InventoryActionTracker {
   ...
   public void tick(long longValue, InventoryActionTracker.Environment environment, InventoryPlanService.Policy currentPolicy, int value, int currentValue) {
         ...
         if (!inventoryCellData.paused() && inventoryCellData.cursorEmpty()) {
            ...
            if (longValue >= this.timestamp) {
               ...
               if (this.items.isEmpty()) {
                  InventoryPlanService.Plan currentPlan = this.inventoryPlanService.plan(inventoryCellData, currentPolicy);
                     ...
                     this.timestamp = longValue
                        ...
                        + (int)(
                           (previousValue - nextValue)
                              * (this.randomGenerator.nextDouble() + this.randomGenerator.nextDouble())
                              / 2.0
                        );
                  }
               }
