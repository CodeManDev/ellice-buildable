...
public final class InventoryRecordService {
   ...
   public void record(Object value, Object currentValue, InventoryRecordService.Kind kind, long longValue) {
      this.opening = value != null && kind != null ? new InventoryRecordService.Opening(value, currentValue, kind, longValue) : null;
   }

   public boolean consume(Object value, Object currentValue, InventoryRecordService.Kind currentKind, long longValue) {
   ...
   private record Opening(Object level, Object previousMenu, InventoryRecordService.Kind kind, long at) {
   }
}
