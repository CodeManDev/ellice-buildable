...
public final class TaskCheckValidator {
   ...
   public static List<TaskCheckValidator.Deficit> check(Map<String, Integer> entries) {
      ...
      if (value < 16) {
         arrayList.add(new TaskCheckValidator.Deficit(TreeHarvestTask.trunkIds(), 16 - value, "Chop trees"));
      }
      ...
      if (currentValue < 10) {
         arrayList.add(new TaskCheckValidator.Deficit(SurvivalAllService.all().keySet(), 10 - currentValue, "Gather food (food phase)"));
      }
