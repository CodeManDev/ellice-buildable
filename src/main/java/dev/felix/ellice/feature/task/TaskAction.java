...
public sealed interface TaskAction
   ...
   TaskAction.Done,
   TaskAction.Abort {
   static TaskAction.Goto go(TravelIsInGoalHandler travelIsInGoal, String text, List<TravelData> items, boolean enabled, TravelPolicy travelPolicy) {
   ...
   record Goto(TravelIsInGoalHandler goal, String label, List<TravelData> route, boolean arrived, boolean canSprint) implements TaskAction {
      public Goto(TravelIsInGoalHandler goal, String label, List<TravelData> route, boolean arrived, boolean canSprint) {
