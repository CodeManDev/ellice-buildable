...
public final class LayoutCodec {
  ...
  public static final LayoutCodec TOP_CENTER =
      new LayoutCodec(LayoutCodec.H.CENTER, LayoutCodec.V.TOP);
  public static final LayoutCodec TOP_RIGHT =
      new LayoutCodec(LayoutCodec.H.RIGHT, LayoutCodec.V.TOP);
  public static final LayoutCodec MIDDLE_LEFT =
      new LayoutCodec(LayoutCodec.H.LEFT, LayoutCodec.V.CENTER);
  public static final LayoutCodec CENTER =
      new LayoutCodec(LayoutCodec.H.CENTER, LayoutCodec.V.CENTER);
  public static final LayoutCodec MIDDLE_RIGHT =
      new LayoutCodec(LayoutCodec.H.RIGHT, LayoutCodec.V.CENTER);
  public static final LayoutCodec BOTTOM_LEFT =
      new LayoutCodec(LayoutCodec.H.LEFT, LayoutCodec.V.BOTTOM);
  public static final LayoutCodec BOTTOM_CENTER =
      new LayoutCodec(LayoutCodec.H.CENTER, LayoutCodec.V.BOTTOM);
  public static final LayoutCodec BOTTOM_RIGHT =
      new LayoutCodec(LayoutCodec.H.RIGHT, LayoutCodec.V.BOTTOM);
  ...
  public boolean equals(Object value) {
    return value instanceof LayoutCodec layoutCodec
        && layoutCodec.h == this.h
        && layoutCodec.v == this.v;
  }
