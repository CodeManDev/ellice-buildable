...
public final class FpsElementRenderer extends TextElementRenderer {
   ...
   public void draw(
      ...
      super.draw(compositorPushPresentationScale, this.createLayoutIsContainerService(layoutIsContainer, "{fps} FPS"), width, height, value, currentValue, layoutOperation, nextValue, previousValue);
   }
   ...
   public HudElementRenderer.Size measure(LayoutIsContainerService layoutIsContainer, LayoutOperationHandler layoutOperation, float value, float currentValue) {
      return super.measure(this.createLayoutIsContainerService(layoutIsContainer, "{fps} FPS"), layoutOperation, value, currentValue);
   }
   ...
   public HudElementRenderer.Size measure(LayoutIsContainerService layoutIsContainer, LayoutOperationHandler layoutOperation, float value, float currentValue, CompositorPushPresentationScaleService compositorPushPresentationScale) {
      return super.measure(this.createLayoutIsContainerService(layoutIsContainer, "{fps} FPS"), layoutOperation, value, currentValue, compositorPushPresentationScale);
   }

   private LayoutIsContainerService createLayoutIsContainerService(LayoutIsContainerService layoutIsContainer, String currentText) {
