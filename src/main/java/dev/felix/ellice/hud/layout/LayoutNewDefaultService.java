...
public final class LayoutNewDefaultService {
   ...
   public static LayoutFindSelector newDefault() {
      ...
      LayoutIsContainerService layoutIsContainer = new LayoutIsContainerService(createText2("fps"), "fps");
      ...
      LayoutIsContainerService currentLayoutIsContainer = new LayoutIsContainerService(createText2("coords"), "coords");
   ...
   public static LayoutIsContainerService createText() {
      LayoutIsContainerService layoutIsContainer = new LayoutIsContainerService(createText2("text"), "text");
   ...
   public static LayoutIsContainerService createRect() {
      LayoutIsContainerService layoutIsContainer = new LayoutIsContainerService(createText2("rect"), "rect");
      layoutIsContainer.anchor = LayoutCodec.CENTER;
   ...
   public static LayoutIsContainerService createBar(String text) {
      LayoutIsContainerService layoutIsContainer = new LayoutIsContainerService(createText2("bar"), "bar");
   ...
   public static LayoutIsContainerService createArmorHud() {
      LayoutIsContainerService layoutIsContainer = new LayoutIsContainerService(createText2("armorhud"), "armorhud");
      layoutIsContainer.anchor = LayoutCodec.CENTER;
   ...
   public static LayoutIsContainerService createKeystrokes() {
      LayoutIsContainerService layoutIsContainer = new LayoutIsContainerService(createText2("keystrokes"), "keystrokes");
      layoutIsContainer.anchor = LayoutCodec.CENTER;
   ...
   private static void updateState(LayoutIsContainerService layoutIsContainer, String currentText, float value, int currentValue, String nextText) {
   ...
   private static void updateState2(LayoutIsContainerService layoutIsContainer, float value, float currentValue, int nextValue) {
      JsonObject jsonObject = layoutIsContainer.props;
   ...
   private static String createText2(String text) {
      return text + "-" + Long.toHexString(System.nanoTime() ^ System.identityHashCode(text)).substring(0, 6);
   }
}
