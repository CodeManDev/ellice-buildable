...
public final class TickBaseStatusHud implements ComponentOperationHandler {
   private ComponentThemeService componentThemeService;
   private String text2 = "TickBase";
      ...
      return ComponentBoxService.row(
            ...
            ComponentBoxService.panel(
                  ComponentStyleService.style()
                     ...
                     .align(ScenePctService.Align.CENTER)
                     .build(),
                  item -> item.direction(ScenePctService.Direction.ROW)
                     .cornerRadius(5.0F)
