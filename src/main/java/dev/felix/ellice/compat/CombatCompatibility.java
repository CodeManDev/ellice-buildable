...
public interface CombatCompatibility {
  Optional<RotationFrameContext> capture(
  ...
  default void applyServerRotation(
      Minecraft minecraft, RotationData rotationData, CombatOwnsService.Owner owner) {
