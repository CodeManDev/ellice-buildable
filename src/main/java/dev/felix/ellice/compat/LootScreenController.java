...
public final class LootScreenController {
  ...
  public String tick(TaskAction.Loot loot) {
    ...
    if (minecraft.player != null
      ...
      LootScreenController.BlockPos3Key currentX =
          new LootScreenController.BlockPos3Key(loot.pos().x(), loot.pos().y(), loot.pos().z());
      ...
      if (minecraft.screen != null && minecraft.screen != this.screen2) {
        ...
        if (longValue < this.timestamp2) {
          ...
          return this.screen2 == null
              ? this.createText(minecraft, currentX)
              : this.createText2(minecraft, longValue);
        }
      }
    } else {
