...
public final class CompatActiveService {
  ...
  public static void follow(
      Minecraft minecraft, RotationData currentRotationData, float currentValue, float nextValue) {
  ...
  public static float[] sample() {
    if (enabled && rotationData != null) {
      ...
      if (minecraft != null && minecraft.player != null) {
        ...
        float currentValue =
            timestamp == 0L ? 0.016666668F : (float) (longValue - timestamp) / 1.0E9F;
        timestamp = longValue;
        RotationData currentRotationData =
            step(new RotationData(value, value2), rotationData, currentValue, value3, value4);
  ...
  public static RotationData step(
    ...
    if (rotationData != null && currentRotationData != null) {
      float previousValue =
          !(value <= 0.0F) && Float.isFinite(value) ? Math.min(value, 0.05F) : 0.0F;
      ...
      float sourceValue =
          0.016F
              + calculateValue(currentValue, 0.0F, 1.0F)
                  * calculateValue(currentValue, 0.0F, 1.0F)
                  * 0.28F;
      ...
      return new RotationData(
          rotationData.yaw() + nextDoubleValue,
          RotationData.clampPitch(rotationData.pitch() + previousDoubleValue));
    } else {
