...
public class PluginRepository {
   ...
   static PluginRepository fromDirectory(Path path) {
      ...
      try {
         ...
         PluginRepository.Meta meta = (PluginRepository.Meta)new Gson().fromJson(text, PluginRepository.Meta.class);
   ...
   public record Meta(String id, String name, String version, String author, String description, String[] permissions, String keybind) {
   }
}
