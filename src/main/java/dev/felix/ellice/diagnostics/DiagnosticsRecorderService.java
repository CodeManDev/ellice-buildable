...
public final class DiagnosticsRecorderService {
  ...
  public DiagnosticsRecorderService(
      SceneDtService sceneDt, DiagnosticsAddFrameListenerService diagnosticsAddFrameListener) {
  ...
  public DiagnosticsRecorderService(
      ...
      Supplier<RenderDiagnosticsSnapshot> supplier) {
  ...
  private final class OverlayPanel extends SceneCornerRadiusService {
    ...
    private DiagnosticsData diagnosticsData =
        DiagnosticsData.capture(DiagnosticsRecorderService.this.fpky0sollh);
    ...
    protected void draw(CompositorPushPresentationScaleService compositorPushPresentationScale) {
      ...
      if (!(this.cw < 150.0F) && !(this.ch < 150.0F)) {
        ...
        this.updateState7(
            ...
            true);
        int nextValue =
            DiagnosticsRecorderService.this.diagnosticsIsRecordingService != null
                    && DiagnosticsRecorderService.this.diagnosticsIsRecordingService.isRecording()
                ? 1
                : 0;
        this.updateState6(
            compositorPushPresentationScale,
            ...
            nextValue != 0
                ? "REC "
                    + DiagnosticsRecorderService.this.diagnosticsIsRecordingService.framesCaptured()
                    + "/"
                    + DiagnosticsRecorderService.this.diagnosticsIsRecordingService.framesTarget()
                : "LIVE  /  F4",
            10.0F,
        ...
        this.updateState5(
            ...
            currentValue + 28.0F,
            previousValue,
            this.diagnosticsData.samples() == 0
                ? "--"
                : DiagnosticsRecorderService.createText("%.0f", this.diagnosticsData.fps()),
            "FPS",
        ...
        this.updateState5(
            ...
            "P95 / ms",
            this.diagnosticsData.p95Ms() > 16.67
        ...
        this.updateState6(
            ...
            MaterialIsLightService.ON_SURFACE_VARIANT);
        this.updateState2(
            compositorPushPresentationScale, height, sourceValue + 10.0F, value, targetValue);
        ...
        if (this.ch < 360.0F) {
            ...
            if (inputValue + 32.0F < this.cy + this.ch - 8.0F) {
              this.updateState7(
                  ...
                  DiagnosticsRecorderService.createText(
                      "%.2f ms CPU  /  %d captured",
                      this.diagnosticsData.section("shaderesp"), this.renderer2.captured()),
                  10.0F,
                  MaterialIsLightService.ON_SURFACE_VARIANT,
                  false);
            }
          ...
          if (inputValue + 142.0F < this.cy + this.ch - 12.0F) {
            ...
            for (int index = 0;
                index < DiagnosticsAddFrameListenerService.SECTIONS.length;
                index++) {
          ...
          if (inputValue + 76.0F < this.cy + this.ch - 12.0F) {
            ...
            for (int currentIndex = 0;
                currentIndex < DiagnosticsAddFrameListenerService.SECTIONS_COMPOSITOR.length;
                currentIndex++) {
              String nextText =
                  DiagnosticsAddFrameListenerService.SECTIONS_COMPOSITOR[currentIndex];
              ...
              this.updateState6(
                  ...
                  resultValue,
                  DiagnosticsRecorderService.createText(
                      "%.2f", this.diagnosticsData.section(nextText)),
                  10.0F,
                  MaterialIsLightService.ON_SURFACE);
            }
          }
    ...
    private void updateState2(
      ...
      compositorPushPresentationScale.pushClip(
          value, currentValue, nextValue, previousValue, 16.0F);
        ...
        if (!(doubleValue >= this.diagnosticsData.graph().ceiling())) {
          float targetValue =
              currentValue
                  + 5.0F
                  + (previousValue - 10.0F)
                      * (1.0F - (float) (doubleValue / this.diagnosticsData.graph().ceiling()));
          compositorPushPresentationScale.roundedRect(
              value + 8.0F,
              targetValue,
              sourceValue - 8.0F,
    ...
    private void updateState3(
      ...
      this.updateState6(
          ...
          currentValue + 14.0F,
          DiagnosticsRecorderService.createText(
              "%.2f ms CPU", this.diagnosticsData.section("shaderesp")),
          11.0F,
          MaterialIsLightService.ON_SURFACE);
      this.updateState8(
          compositorPushPresentationScale,
          ...
          11.0F,
          !this.renderer2.status().contains("failed")
                  && !this.renderer2.status().contains("unavailable")
              ? MaterialIsLightService.ON_SURFACE
              : MaterialIsLightService.ERROR,
          false,
          nextValue - 24.0F);
      ...
      this.updateState8(
          ...
          value + 12.0F,
          currentValue + 72.0F,
          this.renderer2.vertices() / 3
              + " triangles / "
              + this.renderer2.width()
              + " x "
              + this.renderer2.height()
              + " mask",
          11.0F,
          MaterialIsLightService.ON_SURFACE_VARIANT,
          false,
      ...
      this.updateState8(
          ...
          "Depth "
              ...
              + DiagnosticsRecorderService.createText(
                  " / %.2f ms copy", this.diagnosticsData.section("shaderesp-depth")),
          10.0F,
          MaterialIsLightService.ON_SURFACE_VARIANT,
          false,
          nextValue - 24.0F);
    ...
    private void updateState4(
      ...
      float targetValue =
          (float)
              Math.clamp(doubleValue / Math.max(0.001, this.diagnosticsData.averageMs()), 0.0, 1.0);
      if (targetValue > 0.0F) {
        compositorPushPresentationScale.roundedRect(
            value + 184.0F,
            currentValue + 4.0F,
      ...
      this.updateState7(
          ...
          value
              - compositorPushPresentationScale.textWidth(
                  text, nextValue, TextMode.REGULAR, "material-roboto"),
          currentValue,
          text,
          nextValue,
          previousValue,
    ...
    private void updateState7(
      ...
      compositorPushPresentationScale.text(
          ...
          nextValue,
          mulAlpha(previousValue, this.effectiveOpacity),
          enabled ? MaterialIsLightService.LABEL : MaterialIsLightService.BODY);
    }
    ...
    private void updateState8(
      ...
      if (compositorPushPresentationScale.textWidth(text, nextValue, TextMode.REGULAR, currentText)
          > sourceValue) {
        while (!text.isEmpty()
            && compositorPushPresentationScale.textWidth(
                    text + "...", nextValue, TextMode.REGULAR, currentText)
                > sourceValue) {
