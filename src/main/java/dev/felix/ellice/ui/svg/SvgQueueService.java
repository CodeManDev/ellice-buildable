...
public final class SvgQueueService {
   ...
   public void init(RhiOperationHandler rhiOperation) {
      ...
      try {
         RhiBlendStateService.ShaderHandle shaderHandle = rhiOperation.createShader(RhiBlendStateService.ShaderStage.VERTEX, RhiRepository.vertex("vector"));
         RhiBlendStateService.ShaderHandle currentShaderHandle = rhiOperation.createShader(RhiBlendStateService.ShaderStage.FRAGMENT, RhiRepository.fragment("vector"));
         RhiBlendStateService.VertexLayout currentVertexLayout = RhiBlendStateService.VertexLayout.of(
            ...
            new RhiBlendStateService.VertexAttribute(1, 1, RhiBlendStateService.VertexFormat.FLOAT, 8L)
         );
         this.pipelineHandle = rhiOperation.createPipeline(
   ...
   public void flushRange(RhiCommandBuffer rhiCommandBuffer, int value, int currentValue, double doubleValue, int nextValue, int previousValue) {
      if (this.enabled && nextValue < previousValue) {
         ...
         for (int previousIndex = nextValue; previousIndex < previousValue; previousIndex++) {
            ...
            rhiCommandBuffer.pushVec4("uTransform", vectorCmd.centerX * targetValue, vectorCmd.centerY * targetValue, vectorCmd.scaleX * targetValue, vectorCmd.scaleY * targetValue);
            ...
            CompositorIntersectService.apply(rhiCommandBuffer, vectorCmd.clip, targetValue, currentValue);
   ...
   private void updateState(int value) {
      if (this.bufferHandle == null || value > this.count) {
         ...
         this.bufferHandle = this.rhiOperationHandler
            .createBuffer(this.count * 4L, RhiBlendStateService.BufferUsage.VERTEX.bit, RhiBlendStateService.BufferAccess.STREAM);
      }
   }
   ...
   public record VectorCmd(
      ...
      public VectorCmd(
         ...
         this(floats, value, currentValue, nextValue, previousValue, sourceValue, targetValue, inputValue, outputValue, resultValue, candidateValue, selectedValue, defaultValue, initialValue, resolvedValue, computedValue, currentFloats, enabled, false);
      }
      ...
      public VectorCmd(
         ...
         this(floats, value, currentValue, nextValue, previousValue, sourceValue, targetValue, inputValue, outputValue, resultValue, candidateValue, selectedValue, defaultValue, initialValue, resolvedValue, computedValue, currentFloats, false);
      }
   }
}
