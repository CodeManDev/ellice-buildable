...
public final class SvgCodec {
    ...
    public SvgCodec transform(float[] fArray) {
        if (fArray[0] == 1.0f && fArray[1] == 0.0f && fArray[2] == 0.0f && fArray[3] == 1.0f && fArray[4] == 0.0f && fArray[5] == 0.0f) {
            return this;
        }
        ArrayList<SubPath> arrayList = new ArrayList<SubPath>(this.f6wrucfhys1a.size());
        for (SubPath subPath : this.f6wrucfhys1a) {
        ...
        while (nArray[0] < string.length()) {
            ...
            switch (n2) {
                ...
                case 67: {
                    ...
                    SvgCodec.me84pwvogkeo(arrayList2, f3, f4, f11, f12, f13, f14, f15, f16);
                    f7 = f13;
                    f8 = f14;
                    f3 = f15;
                    f4 = f16;
                ...
                case 99: {
                    ...
                    SvgCodec.me84pwvogkeo(arrayList2, f3, f4, f17, f12, f13, f14, f18, f19);
                    f7 = f13;
                    f8 = f14;
                    f3 = f18;
                    f4 = f19;
                ...
                case 83: {
                    ...
                    SvgCodec.me84pwvogkeo(arrayList2, f3, f4, f20, f12, f13, f14, f21, f22);
                    f7 = f13;
                    f8 = f14;
                    f3 = f21;
                    f4 = f22;
                ...
                case 115: {
                    ...
                    SvgCodec.me84pwvogkeo(arrayList2, f3, f4, f23, f12, f13, f14, f24, f25);
                    f7 = f13;
                    f8 = f14;
                    f3 = f24;
                    f4 = f25;
                ...
                case 81: {
                    ...
                    float f13 = SvgCodec.readFloat(string, nArray);
                    float f14 = SvgCodec.readFloat(string, nArray);
                    SvgCodec.m328d9dv3uh1(arrayList2, f3, f4, f26, f12, f13, f14);
                    f9 = f26;
                    f10 = f12;
                    f3 = f13;
                    f4 = f14;
                ...
                case 113: {
                    ...
                    float f13 = f3 + SvgCodec.readFloat(string, nArray);
                    float f14 = f4 + SvgCodec.readFloat(string, nArray);
                    SvgCodec.m328d9dv3uh1(arrayList2, f3, f4, f27, f12, f13, f14);
                    f9 = f27;
                    f10 = f12;
                    f3 = f13;
                    f4 = f14;
                ...
                case 84: {
                    ...
                    float f13 = SvgCodec.readFloat(string, nArray);
                    float f14 = SvgCodec.readFloat(string, nArray);
                    SvgCodec.m328d9dv3uh1(arrayList2, f3, f4, f28, f12, f13, f14);
                    f9 = f28;
                    f10 = f12;
                    f3 = f13;
                    f4 = f14;
                ...
                case 116: {
                    ...
                    float f13 = f3 + SvgCodec.readFloat(string, nArray);
                    float f14 = f4 + SvgCodec.readFloat(string, nArray);
                    SvgCodec.m328d9dv3uh1(arrayList2, f3, f4, f29, f12, f13, f14);
                    f9 = f29;
                    f10 = f12;
                    f3 = f13;
                    f4 = f14;
                ...
                case 97: {
                    ...
                    boolean bl = SvgCodec.mg9rcy66gwnk(string, nArray);
                    boolean bl2 = SvgCodec.mg9rcy66gwnk(string, nArray);
                    ...
                    SvgCodec.m99b6fdu5ryn(arrayList2, f3, f4, f30, f31, f12, f13, f14, bl, bl2);
                    f3 = f30;
                    f4 = f31;
                    break;
                }
    ...
    private static void m99b6fdu5ryn(List<Float> list, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean bl, boolean bl2) {
        float f8;
        float f9;
        float f10;
        float f11;
        ...
        float f15 = f3 - f;
        float f16 = f4 - f2;
        if (f5 < Float.intBitsToFloat(981668463) || f6 < Float.intBitsToFloat(981668463) || f15 * f15 + f16 * f16 < Float.intBitsToFloat(953267991)) {
        ...
        float f21 = f20 * f20;
        float f22 = f21 / (f13 = f5 * f5) + (f12 = (f11 = -f18 * f19 + f17 * f14) * f11) / (f10 = f6 * f6);
        if (f22 > 1.0f) {
        ...
        float f35 = SvgCodec.m7qxi17fycvb(1.0f, 0.0f, f31, f32);
        float f36 = SvgCodec.m7qxi17fycvb(f31, f32, f33, f34);
        if (!bl2 && f36 > 0.0f) {
        ...
        int n = Math.max(1, (int)Math.ceil((double)Math.abs(f36) / Double.longBitsToDouble(4609753056924675352L)));
        float f37 = f36 / (float)n;
        float f38 = (float)(Double.longBitsToDouble(0x3FF5555555555555L) * Math.tan((double)f37 / Double.longBitsToDouble(0x4010000000000000L)));
        ...
        for (int i = 0; i < n; ++i) {
            ...
            SvgCodec.me84pwvogkeo(list, f41, f42, f49, f50, f51, f52, f53, f54);
            f41 = f53;
            f42 = f54;
            f39 = f43;
            f40 = f44;
    ...
    private static float m7qxi17fycvb(float f, float f2, float f3, float f4) {
        float f5 = f * f3 + f2 * f4;
        float f6 = (float)Math.sqrt((f * f + f2 * f2) * (f3 * f3 + f4 * f4));
        float f7 = Math.max(Float.intBitsToFloat(-1082130432), Math.min(1.0f, f5 / Math.max(f6, Float.intBitsToFloat(786163455))));
    ...
    private static boolean mg9rcy66gwnk(String string, int[] nArray) {
        boolean bl;
        int n;
        int n2 = string.length();
        for (n = nArray[0]; n < n2 && (string.charAt(n) == ' ' || string.charAt(n) == ','); ++n) {
    ...
    private static void me84pwvogkeo(List<Float> list, float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8) {
        float f9;
        float f10 = f8 - f2;
        float f11 = f7 - f;
        float f12 = Math.abs((f3 - f7) * f10 - (f4 - f8) * f11);
        if ((f12 + (f9 = Math.abs((f5 - f7) * f10 - (f6 - f8) * f11))) * (f12 + f9) < Float.intBitsToFloat(1041865114) * (f11 * f11 + f10 * f10)) {
        ...
        SvgCodec.me84pwvogkeo(list, f, f2, f13, f14, f19, f20, f23, f24);
        SvgCodec.me84pwvogkeo(list, f23, f24, f21, f22, f17, f18, f7, f8);
    }

    private static void m328d9dv3uh1(List<Float> list, float f, float f2, float f3, float f4, float f5, float f6) {
        SvgCodec.me84pwvogkeo(list, f, f2, f + Float.intBitsToFloat(1059760811) * (f3 - f), f2 + Float.intBitsToFloat(1059760811) * (f4 - f2), f5 + Float.intBitsToFloat(1059760811) * (f3 - f5), f6 + Float.intBitsToFloat(1059760811) * (f4 - f6), f5, f6);
    }
