...
public final class BuiltinImageService extends ScenePctService<BuiltinImageService> implements AutoCloseable {
      ...
      if (currentBufferedImage != null) {
         if (currentBufferedImage != this.bufferedImage) {
            if (this.bufferedImage != null
               && (this.bufferedImage.getWidth() != currentBufferedImage.getWidth() || this.bufferedImage.getHeight() != currentBufferedImage.getHeight())) {
            ...
            this.textureHandle = compositorPushPresentationScale.uploadImageTexture(this.textureHandle, currentBufferedImage);
            if (this.textureHandle.valid()) {
               this.bufferedImage = currentBufferedImage;
            }
         }

         float width = Math.min(this.cw / currentBufferedImage.getWidth(), this.ch / currentBufferedImage.getHeight());
