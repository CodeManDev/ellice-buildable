...
final class ColourComponent {
  ...
  ColourComponent(ScenePctService<?> scenePct, Consumer<Integer> currentConsumer) {
    ...
    this.controlLetterSpacingService =
  ...
  private void updateState2() {
    ...
    MotionAnimateService.animate(
        currentSize, MotionColorsContainer.Floats.SCALE, 1.0F, SceneEaseHandler.Spring.SNAPPY);
  }
  ...
  private void updateState5() {
    ...
    float[] floats =
        Color.RGBtoHSB(this.count >>> 16 & 0xFF, this.count >>> 8 & 0xFF, this.count & 0xFF, null);
    this.value = floats[0];
