...
public final class KeyCatalog {
  public static final List<List<KeyCatalog.Key>> MAIN =
      List.of(
          List.of(
              key(256), gap(1.0F), key(290), key(291), key(292), key(293), gap(0.5F), key(294),
              key(295), key(296), key(297), gap(0.5F), key(298), key(299), key(300), key(301)),
          List.of(
              key(96),
              key(49),
              key(50),
          ...
          List.of(
              ...
              key(348, 1.25F),
              key(345, 1.25F)));
  public static final List<List<KeyCatalog.Key>> NAV =
      List.of(
