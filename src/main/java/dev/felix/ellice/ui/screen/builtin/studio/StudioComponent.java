...
public final class StudioComponent extends ScenePctService<StudioComponent> {
   ...
   public StudioComponent(StudioListenerService studioListener, Supplier<StudioValidateValidator.Frame> currentSupplier, Supplier<Float> nextSupplier) {
   ...
   protected void draw(CompositorPushPresentationScaleService compositorPushPresentationScale) {
      ...
      compositorPushPresentationScale.studioPrimitive(
         ...
         new CompositorPushPresentationScaleService.StudioPaint(0, this.supplier2.get(), 0.0F, 0.0F, 1.0F, 0.0F)
      );
