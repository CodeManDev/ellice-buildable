...
public final class BuiltinOriginalService {
   ...
   public void argb(int currentValue) {
      float[] floats = Color.RGBtoHSB(currentValue >> 16 & 0xFF, currentValue >> 8 & 0xFF, currentValue & 0xFF, null);
   ...
   public int shade(float currentValue, float nextValue) {
      return this.count2 & 0xFF000000 | Color.HSBtoRGB(this.value, currentValue, nextValue) & 16777215;
   }

   private void updateState() {
      this.count2 = this.count2 & 0xFF000000
         | Color.HSBtoRGB(this.value, this.value2, this.value3) & 16777215;
      this.text = "";
   }
