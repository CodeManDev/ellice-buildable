  ...
  protected void draw(CompositorPushPresentationScaleService compositorPushPresentationScale) {
    if (this.shapeKind == StudioShapeService.ShapeKind.TEXT) {
      compositorPushPresentationScale.text(
          this.cx + 5.0F, this.cy + 3.0F, "T", 19.0F, -1715982, MaterialIsLightService.LABEL);
      ...
      compositorPushPresentationScale.roundedRect(
          ...
          0.0F);
      compositorPushPresentationScale.roundedRect(
          this.cx + 7.0F, this.cy + 7.0F, 8.0F, 8.0F, 3.0F, -4344587);
      compositorPushPresentationScale.roundedRect(
          this.cx + 15.0F, this.cy + 15.0F, 6.0F, 6.0F, 3.0F, -7416383);
    } else {
      byte byteValue =
      ...
      compositorPushPresentationScale.studioPrimitive(
          ...
          new CompositorPushPresentationScaleService.StudioPaint(
              byteValue, 0.0F, 0.7F, 3.0F, 1.0F, 0.0F));
    }
  }
}
