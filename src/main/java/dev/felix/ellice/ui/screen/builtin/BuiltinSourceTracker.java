...
public final class BuiltinSourceTracker implements ScreenOperationHandler {
  ...
  private final Consumer<String> text3;
  ...
  private PlayerlookupData playerlookupData;
  private long timestamp;
  private boolean enabled;

  public BuiltinSourceTracker(PlayerlookupApiService playerlookupApiService) {
    this(
        playerlookupApiService,
        new Source() {
          private final PlayerlookupLooksValidValidator playerlookupLooksValidValidator =
              PlayerlookupApiService.api();

          @Override
          public CompletableFuture<PlayerlookupData> lookup(String string) {
            return this.playerlookupLooksValidValidator.lookup(string);
          }

          @Override
          public List<String> recent() {
            return this.playerlookupLooksValidValidator.recent();
          }

          @Override
          public void clearRecent() {
            this.playerlookupLooksValidValidator.clearRecent();
          }
        ...
        string -> Minecraft.getInstance().keyboardHandler.setClipboard(string),
        CompatOpenUriService::openUri);
  }

  public BuiltinSourceTracker(
      PlayerlookupApiService playerlookupApiService,
      Source source,
    ...
    this.text2 = consumer2;
    this.text3 = consumer3;
  }
  ...
  public void viewport(float f, float f2) {
    if (f <= 0.0f
        || f2 <= 0.0f
        || Math.abs(this.f4cfgnm8b97t - f) < Float.intBitsToFloat(0x3F000000)
            && Math.abs(this.fgkxnj6zemvl - f2) < Float.intBitsToFloat(0x3F000000)) {
      return;
    }
    this.f4cfgnm8b97t = f;
  ...
  private void updateState() {
    ...
    if (this.materialTerrainTooltipsService != null
        && (scenePctService = this.materialTerrainTooltipsService.findById("player-lookup.query"))
  ...
  private void mfvtpvvupiqc() {
    if (!this.enabled && this.componentMountService != null) {
  ...
  private ComponentKeyService<?> mjreharcon0(ComponentThemeService componentThemeService) {
    this.materialTerrainTooltipsService.backgroundColor(
        ThemeCornerData.current().dimBackground() ? 0x52000000 : 0);
                    ...
                    ((LayoutContainerNode)
                            ((LayoutContainerNode)
                                ...
                                .padding(
                                    this.checkCondition()
                                        ? 0.0f
                                        : (this.fgkxnj6zemvl < Float.intBitsToFloat(1143603200)
                                                            ...
                                                            ((SceneCornerRadiusService)
                                                                ...
                                                                .maxWidth(
                                                                    Float.intBitsToFloat(
                                                                        1150025728)))
                                                        .maxHeight(
                                                            Float.intBitsToFloat(0x444D0000)))
                                                .minHeight(0.0f))
                                        .cornerRadius(
                                            this.checkCondition()
                                                ? 0.0f
                ...
                ComponentBoxService.row(
                        layoutContainerNode ->
                            ((LayoutContainerNode)
                                    ((LayoutContainerNode)
                                            ((LayoutContainerNode)
                                                    layoutContainerNode.flexShrink(0.0f))
                                                .padding(
                                                    Float.intBitsToFloat(0x41400000),
                                                    this.checkCondition()
                                                        ? Float.intBitsToFloat(0x41400000)
                                                        : Float.intBitsToFloat(1103101952)))
                                        .minHeight(Float.intBitsToFloat(0x42400000)))
                                .align(ScenePctService.Align.CENTER),
                        MaterialTextService.text(
                                this.text6.isEmpty() ? "Profiles provided by PlayerDB" : this.text6,
                                Float.intBitsToFloat(0x41400000),
                                    ...
                                    ((LayoutContainerNode)
                                            layoutContainerNode.height(
                                                LayoutOperationHandler.px(
                                                    this.fgkxnj6zemvl
                                                            < Float.intBitsToFloat(1138163712)
            ...
            sceneCornerRadiusService ->
                ((SceneCornerRadiusService)
                        ((SceneCornerRadiusService)
                            ...
                            .align(ScenePctService.Align.CENTER))
                    .justify(ScenePctService.Justify.CENTER),
            MaterialTextService.icon("person", MaterialIsLightService.ON_PRIMARY_CONTAINER)),
        ComponentBoxService.column(
            layoutContainerNode ->
                ((LayoutContainerNode)
            ...
            MaterialTextService.text(
                    "Find a player. Explore their profile.",
                    Float.intBitsToFloat(0x41400000),
                    MaterialIsLightService.ON_SURFACE_VARIANT)
                .props(
                    sceneTextService ->
                        sceneTextService.visible(
                            this.fgkxnj6zemvl >= Float.intBitsToFloat(1138163712)))),
    ...
    return ComponentBoxService.column(
        ...
        ComponentBoxService.row(
            ...
            MaterialTextService.button(
                ...
                this.checkCondition() ? "Find" : "Search",
                () -> this.maw7i8hjacd(this.text4),
                true)),
        MaterialTextService.text(
                "Minecraft username or UUID, with or without dashes.",
                Float.intBitsToFloat(0x41400000),
                MaterialIsLightService.ON_SURFACE_VARIANT)
    ...
    return switch (this.f8ibb5iuezzg.ordinal()) {
      ...
      case 0 ->
          this.createComponentKeyService5(
              "search",
              "A profile starts with a name",
              "Search for a Minecraft player to see their UUID, skin and cape.",
              false);
      case 1 ->
          this.createComponentKeyService5(
              "search", "Looking up " + this.text4, "Fetching the latest profile\u2026", false);
      case 3 ->
          ComponentBoxService.column(
              layoutContainerNode ->
                  ((LayoutContainerNode)
                          ((LayoutContainerNode) layoutContainerNode.id("player-lookup.error"))
                              .flexShrink(0.0f))
                      .gap(Float.intBitsToFloat(0x41400000)),
              this.createComponentKeyService5(
                  "search", "Couldn't load this player", this.text5, true),
              MaterialTextService.button(
                  "player-lookup.retry", "Try again", () -> this.maw7i8hjacd(this.text4), false));
      case 2 -> this.createComponentKeyService6();
    };
  }

  private ComponentKeyService<?> createComponentKeyService5(
      String string, String string2, String string3, boolean bl) {
    return ComponentBoxService.panel(
        ...
        MaterialTextService.icon(
            string, bl ? MaterialIsLightService.ERROR : MaterialIsLightService.PRIMARY),
        MaterialTextService.text(
                string2,
                Float.intBitsToFloat(1102053376),
                bl ? MaterialIsLightService.ERROR : MaterialIsLightService.ON_SURFACE)
            .props(sceneTextService -> sceneTextService.wordWrap(true)),
        MaterialTextService.text(
                string3,
                Float.intBitsToFloat(1096810496),
                bl ? MaterialIsLightService.ERROR : MaterialIsLightService.ON_SURFACE_VARIANT)
            .props(sceneTextService -> sceneTextService.wordWrap(true)));
  }

  private ComponentKeyService<?> createComponentKeyService6() {
    PlayerlookupData playerlookupData = this.playerlookupData;
            ...
            ((LayoutContainerNode)
                    ((LayoutContainerNode)
                            ((LayoutContainerNode)
                                    ((LayoutContainerNode)
                                            ((LayoutContainerNode)
                                                    layoutContainerNode.id("player-lookup.result"))
                                                .size(
                                                    LayoutOperationHandler.percent(
                                                        Float.intBitsToFloat(1120403456)),
                                                    LayoutOperationHandler.auto()))
                                        .flexShrink(0.0f))
                                .direction(
                                    this.f4cfgnm8b97t < Float.intBitsToFloat(1146224640)
        ...
        ComponentBoxService.panel(
            sceneCornerRadiusService ->
                ((SceneCornerRadiusService)
                    ...
                    .backgroundColor(MaterialIsLightService.SURFACE_CONTAINER)
                    .direction(ScenePctService.Direction.COLUMN),
            this.createComponentKeyService7(playerlookupData),
            MaterialTextService.text(
                    playerlookupData.username(),
                    Float.intBitsToFloat(1105199104),
                    MaterialIsLightService.ON_SURFACE)
                .props(
                    sceneTextService ->
                        ((SceneTextService) sceneTextService.id("player-lookup.name"))
                            .wordWrap(true)),
            MaterialTextService.text(
                playerlookupData.skinModel(),
                Float.intBitsToFloat(1096810496),
                MaterialIsLightService.ON_SURFACE_VARIANT),
            MaterialTextService.button(
                "player-lookup.copy-name",
                "Copy name",
                () -> this.updateState5("Name", playerlookupData.username()),
                false),
            MaterialTextService.button(
                "player-lookup.copy-uuid",
                "Copy UUID",
                () -> this.updateState5("UUID", playerlookupData.dashedUuid()),
                true)),
        ComponentBoxService.column(
            layoutContainerNode ->
                ((LayoutContainerNode)
            ...
            this.createComponentKeyService8(
                ...
                MaterialTextService.text(
                    ...
                    MaterialIsLightService.ON_SURFACE_VARIANT),
                MaterialTextService.text(
                        playerlookupData.dashedUuid(),
                        Float.intBitsToFloat(1096810496),
                        MaterialIsLightService.ON_SURFACE)
                    .props(sceneTextService -> sceneTextService.wordWrap(true)),
                MaterialTextService.button(
                    "player-lookup.copy-raw",
                    "Copy without dashes",
                    () -> this.updateState5("UUID", playerlookupData.trimmedUuid()),
                    false)),
            this.createComponentKeyService8(
                "Textures",
                this.createComponentKeyService9(
                    "skin",
                    "Skin",
                    playerlookupData.hasSkin() ? playerlookupData.skinUrl() : null,
                    playerlookupData.skinModel()),
                MaterialTextService.divider(),
                this.createComponentKeyService9(
                    "cape",
                    "Cape",
                    playerlookupData.hasCape() ? playerlookupData.capeUrl() : null,
                    playerlookupData.hasCape() ? "Cape available" : "No cape on this profile"),
                MaterialTextService.text(
                        (String)
                            (playerlookupData.texturesUpdatedAt() == null
                                ? "Texture update time unavailable"
                                : "Updated "
                                    + DateTimeFormatter.ofPattern("dd MMM uuuu")
                                        .withZone(ZoneId.systemDefault())
                                        .format(playerlookupData.texturesUpdatedAt())),
                        Float.intBitsToFloat(0x41400000),
                        MaterialIsLightService.ON_SURFACE_VARIANT)
                    .props(sceneTextService -> sceneTextService.wordWrap(true))),
            this.createComponentKeyService8(
                ...
                this.createComponentKeyService10(
                    "namemc",
                    "NameMC",
                    "https://namemc.com/profile/" + playerlookupData.dashedUuid()),
                this.createComponentKeyService10(
                    "crafty",
                    "Crafty",
                    "https://crafty.gg/players/" + playerlookupData.dashedUuid()),
                this.createComponentKeyService10(
                    "laby", "laby.net", "https://laby.net/@" + playerlookupData.dashedUuid()))));
  }

  private ComponentKeyService<?> createComponentKeyService7(PlayerlookupData playerlookupData) {
    String string = "mc.head." + String.valueOf(playerlookupData.uuid());
    int n =
        this.fewzcie2pwyo != null
                && this.fewzcie2pwyo.getNamedTexture(string) != null
                && this.fewzcie2pwyo.getNamedTexture(string).valid()
            ? 1
            : 0;
    return ComponentBoxService.panel(
        sceneCornerRadiusService ->
        ...
        n != 0
            ? ComponentBoxService.node(
                ...
                sceneTextureService ->
                    ((SceneTextureService)
                            sceneTextureService.size(
                                Float.intBitsToFloat(1115684864), Float.intBitsToFloat(1115684864)))
                        .cornerRadius(Float.intBitsToFloat(1098907648))
                        .textureName(string),
                new ComponentKeyService[0])
            : MaterialTextService.text(
                playerlookupData.username().isEmpty()
                    ? "?"
                    : playerlookupData.username().substring(0, 1).toUpperCase(Locale.ROOT),
                Float.intBitsToFloat(0x42000000),
                MaterialIsLightService.ON_PRIMARY_CONTAINER));
  }

  private ComponentKeyService<?> createComponentKeyService8(
      String string, ComponentKeyService<?>... componentKeyServiceArray) {
    ...
    return ComponentBoxService.column(
        layoutContainerNode ->
            ((LayoutContainerNode)
                ...
                .gap(Float.intBitsToFloat(0x41000000)),
        MaterialTextService.text(
            string2, Float.intBitsToFloat(1098907648), MaterialIsLightService.ON_SURFACE),
        MaterialTextService.text(
                string4,
                Float.intBitsToFloat(1096810496),
                MaterialIsLightService.ON_SURFACE_VARIANT)
        ...
        ComponentBoxService.row(
            layoutContainerNode ->
                ((LayoutContainerNode)
                        ((LayoutContainerNode) layoutContainerNode.flexShrink(0.0f))
                            .gap(Float.intBitsToFloat(0x41000000)))
                    .visible(string3 != null),
            MaterialTextService.button(
                    "player-lookup.copy-" + string,
                    "Copy URL",
                    () -> this.updateState5(string2 + " URL", string3),
                    false)
                .props(
                    materialJoinedService ->
                        ((SceneCornerRadiusService) materialJoinedService.flex(1.0f))
                            .minWidth(0.0f)),
            MaterialTextService.button(
                "player-lookup.open-" + string, "Open", () -> this.updateState6(string3), false)));
  }

  private ComponentKeyService<?> createComponentKeyService10(
      String string, String string2, String string3) {
    return MaterialTextService.button(
            "player-lookup.link-" + string, string2, () -> this.updateState6(string3), false)
        .props(
            materialJoinedService ->
                materialJoinedService.width(
                    LayoutOperationHandler.percent(Float.intBitsToFloat(1120403456))))
        .children(
            MaterialTextService.icon("open_in_new", MaterialIsLightService.ON_SECONDARY_CONTAINER),
            MaterialTextService.label(string2, MaterialIsLightService.ON_SECONDARY_CONTAINER));
  }
  ...
  private ComponentKeyService<?> createComponentKeyService11() {
    ...
    for (String string : list) {
      arrayList.add(
          MaterialTextService.button(
                  "player-lookup.recent." + string, string, () -> this.maw7i8hjacd(string), false)
              .props(
                  materialJoinedService ->
                      materialJoinedService.width(
                          LayoutOperationHandler.percent(Float.intBitsToFloat(1120403456)))));
    ...
    return ComponentBoxService.column(
        layoutContainerNode ->
            ((LayoutContainerNode)
                    ((LayoutContainerNode)
                            ((LayoutContainerNode) layoutContainerNode.id("player-lookup.recent"))
                                .flexShrink(0.0f))
                        .gap(Float.intBitsToFloat(0x41000000)))
  ...
  private void maw7i8hjacd(String string) {
    ...
    this.text4 = string == null ? "" : string.trim();
    this.playerlookupData = null;
    this.text6 = "";
    ScenePctService<?> scenePctService =
        this.materialTerrainTooltipsService.findById("player-lookup.query");
    ...
    if (!PlayerlookupLooksValidValidator.looksValid(this.text4)) {
      this.f8ibb5iuezzg = Phase.ERROR;
      this.text5 = "Enter a valid Minecraft username or UUID.";
      this.mfvtpvvupiqc();
      return;
    }
    this.faizszxywnws.rememberQuery(this.text4);
                ...
                this.consumer.accept(
                    () -> {
                      ...
                      if (throwable != null || playerlookupData == null) {
                        this.f8ibb5iuezzg = Phase.ERROR;
                        this.text5 =
                            "The player could not be found or the service is unavailable. Check the"
                                + " name and try again.";
                        this.mfvtpvvupiqc();
                        return;
                      }
                      this.playerlookupData = playerlookupData;
                      ...
                      if (playerlookupData.uuid() != null && this.fewzcie2pwyo != null) {
                        this.fb5pbjphroah
                            .head(playerlookupData.uuid())
                            .whenComplete(
                                (bufferedImage, headError) ->
                                    this.consumer.accept(
                                        () -> {
                                          if (this.enabled
                                              || l != this.timestamp
                                          ...
                                          this.fewzcie2pwyo.registerImageTexture(
                                              "mc.head." + String.valueOf(playerlookupData.uuid()),
  ...
  private void updateState5(String string, String string2) {
    if (string2 == null || string2.isBlank()) {
      return;
    }
    this.text2.accept(string2);
    this.text6 = string + " copied";
    this.mfvtpvvupiqc();
  }

  private void updateState6(String string) {
    if (string != null && !string.isBlank()) {
      this.text3.accept(string);
    }
  }
  ...
  public static interface Source {
    ...
    public default CompletableFuture<BufferedImage> head(UUID uUID) {
