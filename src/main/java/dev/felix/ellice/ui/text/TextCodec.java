...
public final class TextCodec
{
    ...
    public static List<Segment> parse(final String s, final int n, final TextData textData) {
        ...
        boolean b2 = textData2.variant() == TextMode.ITALIC || textData2.variant() == TextMode.BOLD_ITALIC;
        final boolean b3 = b;
        final boolean b4 = b2;
    ...
    private static void m5l8sh49s54x(final List<Segment> list, final StringBuilder sb, final int n, final TextData textData) {
        if (sb.length() == 0) {
            return;
        }
    ...
    static {
        fcn1vkkl3fc = new int[] { 0, 170, 43520, 43690, 11141120, 11141290, 16755200, 11184810, 5592405, 5592575, 5635925, 5636095, 16733525, 16733695, 16777045, 16777215 };
    }
