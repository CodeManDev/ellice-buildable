...
public record TextData(
   ...
   public static final TextData NONE = new TextData(0.0F, 0.0F, 0, 0.0F, 0, TextMode.REGULAR, null, 0.0F);

   public TextData(float value, float currentValue, int nextValue, float previousValue, int sourceValue, TextMode textMode, String text, float targetValue) {
      this(value, currentValue, nextValue, previousValue, sourceValue, textMode, text, targetValue, 0.0F);
   }
   ...
   public TextData withShadow(float value, float currentValue, int nextValue) {
      return new TextData(
         value, currentValue, nextValue, this.outlineWidth, this.outlineColor, this.variant, this.fontFamily, this.edgeSoftness, this.letterSpacing
      );
   }

   public TextData withOutline(float value, int currentValue) {
      return new TextData(
         this.shadowX, this.shadowY, this.shadowColor, value, currentValue, this.variant, this.fontFamily, this.edgeSoftness, this.letterSpacing
      );
   }
