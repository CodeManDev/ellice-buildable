...
public final class ComponentBoxService {
  ...
  public static ComponentKeyService<LayoutContainerNode> box(
      Consumer<LayoutContainerNode> consumer, ComponentKeyService<?>... componentKeies) {
    return ComponentKeyService.of("box", LayoutContainerNode::new, consumer, componentKeies);
  }

  public static ComponentKeyService<LayoutContainerNode> box(
      Consumer<LayoutContainerNode> consumer, Object[] components) {
    return box(consumer, componentKeys(components));
  }

  public static ComponentKeyService<LayoutContainerNode> row(
      Consumer<LayoutContainerNode> consumer, ComponentKeyService<?>... componentKeies) {
    return ComponentKeyService.of(
        "row",
  ...
  public static ComponentKeyService<LayoutContainerNode> row(
      ComponentStyleService componentStyle, ComponentKeyService<?>... componentKeies) {
  ...
  public static ComponentKeyService<LayoutContainerNode> row(
      ComponentStyleService componentStyle, Object[] components) {
    return row(componentStyle, componentKeys(components));
  }

  public static ComponentKeyService<LayoutContainerNode> column(
      Consumer<LayoutContainerNode> consumer, ComponentKeyService<?>... componentKeies) {
    return ComponentKeyService.of(
        "column",
        LayoutContainerNode::new,
  ...
  public static ComponentKeyService<LayoutContainerNode> stack(
      Consumer<LayoutContainerNode> consumer, ComponentKeyService<?>... componentKeies) {
    return ComponentKeyService.of(
        "stack",
        LayoutContainerNode::new,
  ...
  public static ComponentKeyService<SceneCornerRadiusService> panel(
      Consumer<SceneCornerRadiusService> consumer, ComponentKeyService<?>... componentKeies) {
    return ComponentKeyService.of("panel", SceneCornerRadiusService::new, consumer, componentKeies);
  }

  public static ComponentKeyService<SceneCornerRadiusService> panel(
      ComponentStyleService componentStyle,
  ...
  public static ComponentKeyService<SceneCornerRadiusService> panel(
      Consumer<SceneCornerRadiusService> consumer, Object[] components) {
  ...
  public static ComponentKeyService<SceneTextService> text(
      String currentText, Consumer<SceneTextService> consumer) {
    return ComponentKeyService.of(
        "text",
        SceneTextService::new,
        item -> {
  ...
  public static ComponentKeyService<SceneSrcService> svg(
      Path path, Consumer<SceneSrcService> consumer) {
    return ComponentKeyService.of(
        "svg",
        SceneSrcService::new,
        item -> {
  ...
  public static <N extends ScenePctService<?>> ComponentKeyService<N> node(
      String text,
      Supplier<N> supplier,
      Consumer<N> consumer,
      ComponentKeyService<?>... componentKeies) {
  ...
  public static <N extends ScenePctService<?>> ComponentKeyService<N> node(
      String text, Supplier<N> supplier, Consumer<N> consumer, Object[] components) {
