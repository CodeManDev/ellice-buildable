...
public final class ComponentStyleService {
  ...
  public void apply(ScenePctService<?> scenePct) {
    Objects.requireNonNull(scenePct, "node")
        ...
        .inset(
            this.layoutOperationHandler8,
            this.layoutOperationHandler9,
            this.layoutOperationHandler10,
            this.layoutOperationHandler11)
  ...
  public static final class Builder {
    ...
    public ComponentStyleService.Builder size(
    ...
    public ComponentStyleService.Builder inset(
    ...
    public ComponentStyleService.Builder padding(
    ...
    public ComponentStyleService.Builder margin(
        float value, float currentValue, float nextValue, float previousValue) {
