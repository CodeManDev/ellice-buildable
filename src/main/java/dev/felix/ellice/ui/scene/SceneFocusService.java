...
public final class SceneFocusService extends ScenePctService<SceneFocusService> {
   public static final MotionFiniteService SERVERS = MotionFiniteService.finite("menuServers", item -> item instanceof SceneFocusService);
   public static final MotionFiniteService WORLDS = MotionFiniteService.finite("menuWorlds", item -> item instanceof SceneFocusService);
   public static final MotionFiniteService FOCUS = MotionFiniteService.finite("menuFocus", item -> item instanceof SceneFocusService);
   ...
   public SceneFocusService page(int value) {
      ...
      MotionAnimateService.animate(
         ...
         SERVERS,
         value == 1 ? 1.0F : 0.0F,
         new SceneEaseHandler.Spring(16.0F, 64.0F)
      );
      MotionAnimateService.animate(
