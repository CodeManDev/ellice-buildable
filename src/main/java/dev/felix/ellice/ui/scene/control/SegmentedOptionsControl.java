...
public class SegmentedOptionsControl extends ScenePctService<SegmentedOptionsControl> {
   ...
   public float intrinsicWidth(CompositorPushPresentationScaleService compositorPushPresentationScale) {
      ...
      for (String id : this.text2) {
         currentValue = Math.max(currentValue, compositorPushPresentationScale.textWidth(id, this.value));
      }
   ...
   protected void draw(CompositorPushPresentationScaleService compositorPushPresentationScale) {
      ...
      compositorPushPresentationScale.roundedRect(this.cx, this.cy, this.cw, this.ch, currentValue, currentValue, currentValue, currentValue, mulAlpha(height, y), 0.0F, 0.0F, 0, 0.0F, 0, 1.0F, width);
