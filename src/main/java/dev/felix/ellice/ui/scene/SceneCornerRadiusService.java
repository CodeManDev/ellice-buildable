...
public class SceneCornerRadiusService extends ScenePctService<SceneCornerRadiusService>
{
    ...
    protected void draw(final CompositorPushPresentationScaleService compositorPushPresentationScaleService) {
        ...
        final float n2 = (effectiveOpacity > Float.intBitsToFloat(1036831949)) ? (this.shadow * effectiveOpacity) : 0.0f;
        ...
        if (!this.glass) {
            if (this.blur > 0.0f) {
                if (n >>> 24 == 0 && n2 <= 0.0f && this.borderWidth <= 0.0f && this.innerHighlight <= 0.0f) {
                    return;
                }
                compositorPushPresentationScaleService.addRect(this.cx, this.cy, this.cw, this.ch, n3, n4, n5, n6, n, this.blur, n2, mulAlpha, this.borderWidth, mulAlpha2, effectiveOpacity, effectiveEdgeSoftness, this.insetShadow, this.gradientEnd, mulAlpha3, this.innerHighlight * effectiveOpacity, this.innerHighlightSize);
            }
            else {
                final int mulAlpha4 = ScenePctService.mulAlpha(n, effectiveOpacity);
                if (mulAlpha4 >>> 24 == 0 && n2 <= 0.0f && this.borderWidth <= 0.0f && this.innerHighlight <= 0.0f) {
                    return;
                }
                compositorPushPresentationScaleService.addRect(this.cx, this.cy, this.cw, this.ch, n3, n4, n5, n6, mulAlpha4, 0.0f, n2, mulAlpha, this.borderWidth, mulAlpha2, 1.0f, effectiveEdgeSoftness, this.insetShadow, this.gradientEnd, mulAlpha3, this.innerHighlight * effectiveOpacity, this.innerHighlightSize);
            }
            return;
        }
        ...
        final boolean b2 = this.borderWidth > 0.0f && (mulAlpha2 >>> 24 != 0 || mulAlpha3 >>> 24 != 0 || mulAlpha5 >>> 24 != 0);
        if (!b && n2 <= 0.0f && !b2) {
            return;
        }
        if (n2 > 0.0f) {
            compositorPushPresentationScaleService.addRect(this.cx, this.cy, this.cw, this.ch, n3, n4, n5, n6, 0, 0.0f, n2, mulAlpha, 0.0f, 0, 1.0f, effectiveEdgeSoftness, this.insetShadow, 0, 0, 0.0f, 0.0f);
        }
        this.mebj2teccfae(compositorPushPresentationScaleService);
        compositorPushPresentationScaleService.glassRect(this.cx, this.cy, this.cw, this.ch, n3, n4, n5, n6, n, this.gradientEnd, (this.blur > 0.0f) ? this.blur : Float.intBitsToFloat(1099956224), effectiveOpacity, this.glassSaturation, this.glassBrightness, this.glassContrast, this.glassRefraction, this.glassNoise, this.glassChromatic, this.borderWidth, mulAlpha2, mulAlpha3, mulAlpha5, effectiveEdgeSoftness, this.edgeWobble, this.edgeWobbleRadius, this.f9l80ymct3u4, this.fdyk71mweq49, this.fpegc9vd0i2, this.fggo4jo1cxh9);
    }
    ...
    static int lerpColor(final int n, final int n2, final float n3) {
        ...
        return mgfgubwgbztx(n >> 24 & 0xFF, n2 >> 24 & 0xFF, n3) << 24 | mgfgubwgbztx(n >> 16 & 0xFF, n2 >> 16 & 0xFF, n3) << 16 | mgfgubwgbztx(n >> 8 & 0xFF, n2 >> 8 & 0xFF, n3) << 8 | mgfgubwgbztx(n & 0xFF, n2 & 0xFF, n3);
    }
    ...
    private void mebj2teccfae(final CompositorPushPresentationScaleService compositorPushPresentationScaleService) {
        final float min = Math.min(Float.intBitsToFloat(1028443341), Math.max(0.0f, SceneDtService.dt()));
        if (this.edgeWobble <= Float.intBitsToFloat(981668463) || this.cw <= 1.0f || this.ch <= 1.0f || min <= 0.0f) {
        ...
        if (this.f9l80ymct3u4 >= 0.0f) {
            ...
            if (mjmbt0hjvedt.score > Float.intBitsToFloat(1014350479) && (mjmbt0hjvedt.score > rubberTarget.score * Float.intBitsToFloat(1054280253) || Math.abs(this.fpegc9vd0i2) > this.edgeWobble * Float.intBitsToFloat(1043878380))) {
                m5mou0kje00 = mjmbt0hjvedt;
            }
        }
        float amount = 0.0f;
        if (m5mou0kje00.score > Float.intBitsToFloat(1014350479)) {
            if (this.f9l80ymct3u4 < 0.0f || Math.abs(this.fpegc9vd0i2) < this.edgeWobble * Float.intBitsToFloat(1042536202)) {
                this.f9l80ymct3u4 = (float)m5mou0kje00.side;
                this.fdyk71mweq49 = m5mou0kje00.tangent;
                this.fggo4jo1cxh9 = m5mou0kje00.width;
            }
            else if ((int)this.f9l80ymct3u4 != m5mou0kje00.side && Math.abs(this.fpegc9vd0i2) < this.edgeWobble * Float.intBitsToFloat(1051595899)) {
                this.f9l80ymct3u4 = (float)m5mou0kje00.side;
                this.fdyk71mweq49 = m5mou0kje00.tangent;
                this.fggo4jo1cxh9 = m5mou0kje00.width;
            }
        ...
        if (m5mou0kje00.score <= Float.intBitsToFloat(1014350479) && Math.abs(this.fpegc9vd0i2) < Float.intBitsToFloat(1020054733) && Math.abs(this.f3pppfacncsz) < Float.intBitsToFloat(1028443341)) {
            this.f9l80ymct3u4 = Float.intBitsToFloat(-1082130432);
    ...
    private void mbbzv0tuxnv5(final float n, final float n2) {
        ...
        for (int i = 0; i < n3; ++i) {
            this.f3pppfacncsz += (Float.intBitsToFloat(-1018036224) * (this.fpegc9vd0i2 - n) - Float.intBitsToFloat(1104674816) * this.f3pppfacncsz) * n4;
    ...
    private RubberTarget mjmbt0hjvedt(final int n, final float n2, final float n3) {
        final float max = Math.max(Float.intBitsToFloat(1099431936), this.edgeWobble * Float.intBitsToFloat(1082130432));
        final float max2 = Math.max(Float.intBitsToFloat(1103626240), this.edgeWobble * Float.intBitsToFloat(1085695590));
        ...
        final float mayen93awqyi = mayen93awqyi((1.0f - m3cy849k25oe(this.edgeWobble * Float.intBitsToFloat(1041865114), this.edgeWobbleRadius * Float.intBitsToFloat(1052266988), Math.abs(n8) - n9)) * (1.0f - m3cy849k25oe(this.edgeWobbleRadius * Float.intBitsToFloat(1036831949), this.edgeWobbleRadius * Float.intBitsToFloat(1062836634), Math.max(0.0f, Math.max(-n11, n11 - n12)))));
        if (mayen93awqyi <= 0.0f) {
            return RubberTarget.NONE;
        }
        final float mayen93awqyi2 = mayen93awqyi((n9 - Math.abs(n8) + this.edgeWobble * Float.intBitsToFloat(1066611507)) / Math.max(1.0f, n9 + this.edgeWobble * Float.intBitsToFloat(1066611507)));
        return new RubberTarget(n, m9rtvz4w16qe(n11, 0.0f, n12), ((n8 >= 0.0f) ? Float.intBitsToFloat(-1082130432) : 1.0f) * this.edgeWobble * (Float.intBitsToFloat(1043878380) + Float.intBitsToFloat(1063004406) * mayen93awqyi2) * mayen93awqyi, Math.max(Float.intBitsToFloat(1099956224), n10 + this.edgeWobbleRadius * (Float.intBitsToFloat(1055622431) + Float.intBitsToFloat(1043878380) * mayen93awqyi)), mayen93awqyi * (Float.intBitsToFloat(1050253722) + Float.intBitsToFloat(1060320051) * mayen93awqyi2));
    }
    ...
    private static float m3cy849k25oe(final float n, final float n2, final float n3) {
        final float mayen93awqyi = mayen93awqyi((n3 - n) / Math.max(Float.intBitsToFloat(953267991), n2 - n));
