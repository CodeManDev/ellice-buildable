...
public class SceneTextureService extends ScenePctService<SceneTextureService> {
   ...
   protected void draw(CompositorPushPresentationScaleService compositorPushPresentationScale) {
      ...
      if (this.text != null) {
         RhiBlendStateService.TextureHandle nextTextureHandle = compositorPushPresentationScale.getNamedTexture(this.text);
      ...
      if (currentTextureHandle != null && currentTextureHandle.valid()) {
         ...
         if (this.enabled) {
            ...
            compositorPushPresentationScale.drawTexture(
               currentTextureHandle, this.cx, this.cy, this.cw, this.ch, this.effectiveOpacity, height, currentValue, nextValue, previousValue, this.count, 0.0F, sourceValue
            );
         }
      }
   }
