...
public final class SceneContentService extends ScenePctService<SceneContentService> {
  ...
  private static final SceneEaseHandler.Tween tween =
      new SceneEaseHandler.Tween(0.26F, SceneEaseHandler.Easing.EXPRESSIVE_OUT);
  private static final SceneEaseHandler.Tween tween2 =
      new SceneEaseHandler.Tween(0.2F, SceneEaseHandler.Easing.EASE_IN_OUT);
  private static final SceneEaseHandler.Tween tween3 =
      new SceneEaseHandler.Tween(0.22F, SceneEaseHandler.Easing.EXPRESSIVE_OUT);
  ...
  public SceneContentService content(ScenePctService<?> scenePct) {
    return this.scenePctService == scenePct
        ? this
        : this.reconcileChildren(scenePct == null ? List.of() : List.of(scenePct));
  }
  ...
  private void updateState6(float value, SceneEaseHandler sceneEase, long offset) {
    this.animate(
        ...
        0,
        false,
        () -> this.updateState7(offset, value));
  }
