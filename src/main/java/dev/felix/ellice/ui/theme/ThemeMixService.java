...
public final class ThemeMixService {
  ...
  public static int mix(int value, int currentValue, float nextValue) {
    ...
    return calculateValue(
        calculateValue5(floats[0], currentFloats[0], nextValue),
        calculateValue5(floats[1], currentFloats[1], nextValue),
        calculateValue5(floats[2], currentFloats[2], nextValue),
        previousValue);
  }
  ...
  public static int saturate(int value, float currentValue) {
    ...
    return calculateValue(
        floats[0], floats[1] * nextValue, floats[2] * nextValue, calculateValue4(value));
  }
  ...
  public static int contrastText(int value) {
    ...
    float sourceValue = 0.2126F * currentValue + 0.7152F * nextValue + 0.0722F * previousValue;
  ...
  private static float[] createFloat(int value) {
    ...
    float previousValue = calculateValue2((value & 0xFF) / 255.0F);
    float sourceValue =
        0.41222146F * currentValue + 0.53633255F * nextValue + 0.051445995F * previousValue;
    float targetValue =
        0.2119035F * currentValue + 0.6806995F * nextValue + 0.10739696F * previousValue;
    float inputValue =
        0.08830246F * currentValue + 0.28171885F * nextValue + 0.6299787F * previousValue;
  ...
  private static int calculateValue(
    ...
    float selectedValue =
        4.0767417F * outputValue - 3.3077116F * resultValue + 0.23096994F * candidateValue;
    float defaultValue =
        -1.268438F * outputValue + 2.6097574F * resultValue - 0.3413194F * candidateValue;
    float initialValue =
        -0.00419609F * outputValue - 0.7034186F * resultValue + 1.7076147F * candidateValue;
  ...
  private static float calculateValue3(float value) {
    return value <= 0.0031308F
        ? 12.92F * value
        : 1.055F * (float) Math.pow(value, 0.4166666666666667) - 0.055F;
  }
