...
public record ThemeCornerData(
   ...
   public ThemeCornerData(
      ...
      tooltipDelay = Float.isFinite(tooltipDelay)
         ? Math.clamp(tooltipDelay, 0.0F, 1.5F)
         : 0.4F;
   ...
   public ThemeCornerData(
      ...
      this(notificationMode, notificationDuration, corner, value, enabled, currentValue, nextValue, currentEnabled, nextEnabled, previousEnabled, true);
   }
