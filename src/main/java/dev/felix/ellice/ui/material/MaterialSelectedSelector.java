...
public final class MaterialSelectedSelector extends SceneSrcService {
   private static final MotionFiniteService motionFiniteService = MotionFiniteService.finite("rotation", item -> item instanceof SceneSrcService);
   ...
   public MaterialSelectedSelector selected(boolean currentEnabled) {
      if (this.enabled && this.enabled2 != currentEnabled) {
         ...
         MotionAnimateService.animate(this, MotionColorsContainer.Floats.SCALE, 1.0F, MaterialEnterService.RELEASE);
