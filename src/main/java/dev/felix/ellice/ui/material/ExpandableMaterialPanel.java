...
public final class ExpandableMaterialPanel extends LayoutContainerNode {
  private static final MotionFiniteService motionFiniteService =
      MotionFiniteService.finite(
          "materialRevealHeight", item -> item instanceof ExpandableMaterialPanel);
  private static final SceneEaseHandler.Spring spring = new SceneEaseHandler.Spring(39.0F, 520.0F);
  private static final SceneEaseHandler.Spring spring2 = new SceneEaseHandler.Spring(48.0F, 640.0F);
  ...
  public ExpandableMaterialPanel expanded(boolean currentEnabled) {
    ...
    if (!this.enabled2) {
      ...
      MotionAnimateService.animate(
          this, motionFiniteService, this.value3, currentEnabled ? spring : spring2);
      return this;
    }
  }
    ...
    if (!this.children().isEmpty()) {
      ...
      if (!this.enabled2) {
        ...
        if (nextValue != 0) {
          ...
          this.value3 = this.enabled ? currentValue : 0.0F;
          MotionAnimateService.animate(
              this, motionFiniteService, this.value3, this.enabled ? spring : spring2);
        }
      }
    }
  }
