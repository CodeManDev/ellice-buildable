...
public record MaterialData(Map<String, Integer> colors) {
   ...
   public static MaterialData create(int value, int currentValue, boolean enabled) {
      ...
      linkedHashMap.put(
         "SURFACE",
         calculateValue4(doubles[0], doubleValue, enabled ? 0.975 : 0.08)
      );
      linkedHashMap.put("SURFACE_LOWEST", calculateValue4(doubles[0], doubleValue, enabled ? 1.0 : 0.055));
      linkedHashMap.put(
         "SURFACE_LOW",
         calculateValue4(doubles[0], doubleValue, enabled ? 0.96 : 0.115)
      );
      linkedHashMap.put(
         "SURFACE_CONTAINER",
         calculateValue4(doubles[0], doubleValue, enabled ? 0.935 : 0.14)
      );
      linkedHashMap.put(
         "SURFACE_HIGH",
         calculateValue4(doubles[0], doubleValue, enabled ? 0.91 : 0.18)
      );
      linkedHashMap.put(
         "SURFACE_HIGHEST",
         calculateValue4(doubles[0], doubleValue, enabled ? 0.88 : 0.225)
      );
      linkedHashMap.put(
         "PRIMARY",
         calculateValue3(
            calculateValue4(
               currentDoubles[0], currentDoubleValue, enabled ? 0.38 : 0.78
            ),
      ...
      linkedHashMap.put(
         ...
         calculateValue3(
            calculateValue4(
               currentDoubles[0] + 0.12,
               currentDoubleValue * 0.7,
               enabled ? 0.38 : 0.78
            ),
            (Integer)linkedHashMap.get("SURFACE_HIGHEST"),
            4.5
      ...
      linkedHashMap.put(
         ...
         calculateValue3(
            calculateValue4(
               doubles[0], doubleValue, enabled ? 0.12 : 0.91
            ),
            (Integer)linkedHashMap.get("SURFACE_HIGHEST"),
            7.0
         )
      ...
      linkedHashMap.put(
         ...
         calculateValue3(
            calculateValue4(
               doubles[0], doubleValue, enabled ? 0.34 : 0.8
            ),
            (Integer)linkedHashMap.get("SURFACE_HIGHEST"),
            4.5
         )
      ...
      linkedHashMap.put(
         ...
         calculateValue3(
            calculateValue4(
               doubles[0], doubleValue, enabled ? 0.44 : 0.62
            ),
            (Integer)linkedHashMap.get("SURFACE_HIGHEST"),
            3.0
         )
      ...
      linkedHashMap.put(
         "OUTLINE_VARIANT",
         calculateValue4(doubles[0], doubleValue, enabled ? 0.76 : 0.3)
      );
      linkedHashMap.put(
         "ERROR",
         calculateValue3(enabled ? -4580838 : -870219, (Integer)linkedHashMap.get("SURFACE_HIGHEST"), 4.5)
      );
      ...
      linkedHashMap.put(
         ...
         calculateValue4(
            nextDoubles[0],
            Math.min(0.6, nextDoubles[1]),
            enabled ? 0.9 : 0.25
         )
      );
      linkedHashMap.put(
         "ON_ERROR_CONTAINER",
         calculateValue3(enabled ? -12517374 : -9514, (Integer)linkedHashMap.get("ERROR_CONTAINER"), 4.5)
      );
      linkedHashMap.put(
         "INVERSE_SURFACE",
         calculateValue4(doubles[0], doubleValue, enabled ? 0.2 : 0.9)
      );
      linkedHashMap.put(
         "INVERSE_ON_SURFACE",
         calculateValue3(
            calculateValue4(
               doubles[0], doubleValue, enabled ? 0.95 : 0.16
            ),
   ...
   private static double[] createDouble(int value) {
      ...
      double previousDoubleValue = Math.max(doubleValue, Math.max(currentDoubleValue, nextDoubleValue));
      ...
      double outputDoubleValue = previousDoubleValue == doubleValue
         ? (currentDoubleValue - nextDoubleValue) / targetDoubleValue + (currentDoubleValue < nextDoubleValue ? 6 : 0)
         : (
   ...
   private static int calculateValue4(double doubleValue, double currentDoubleValue, double nextDoubleValue) {
      doubleValue -= Math.floor(doubleValue);
      double previousDoubleValue = (1.0 - Math.abs(2.0 * nextDoubleValue - 1.0)) * currentDoubleValue;
      double sourceDoubleValue = previousDoubleValue
         * (1.0 - Math.abs(doubleValue * 6.0 % 2.0 - 1.0));
