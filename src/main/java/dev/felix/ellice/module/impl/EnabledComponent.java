...
public final class EnabledComponent extends ModuleSettingsService {
  ...
  private final ModuleSetting.Mode moduleMode =
      this.setting(
          new ModuleSetting.Mode("Mode", new String[] {"Static", "Smooth", "Snap"}, "Smooth")
              .description("Tests a three-option mode selector."));
  ...
  private final ModuleSetting.Curve moduleCurve =
      this.setting(
          new ModuleSetting.Curve(
                  "Timing curve", ModuleSetting.CurveValue.cubicBezier(0.25F, 0.1F, 0.25F, 1.0F))
  ...
  private final ModuleSetting.Text moduleText =
      this.setting(
          new ModuleSetting.Text("Label", "ellice", 32)
              .description("Tests a text field with a 32-character limit."));
  private final ModuleSetting.Range moduleRange =
      this.setting(
          new ModuleSetting.Range("Range", 20.0F, 80.0F, 0.0F, 100.0F, 1.0F)
  ...
  private final ModuleSetting.MultiSelect moduleMultiSelect =
      this.setting(
          new ModuleSetting.MultiSelect(
                  "Tags", new String[] {"Glow", "Outline", "Tracer", "Health"}, "Glow", "Health")
