...
public final class ImplRainService extends ModuleSettingsService {
  public final ModuleSetting.Mode mode =
      this.setting(
          new ModuleSetting.Mode("Weather", new String[] {"Clear", "Rain", "Thunder"}, "Clear"));
  public final ModuleSetting.Number strength =
      this.setting(new ModuleSetting.Number("Strength (%)", 100.0F, 0.0F, 100.0F, 1.0F));
  ...
  public ImplRainService() {
    super(
        ModuleBuilderData.builder("WeatherChanger")
            ...
            .description(
                "Changes local rain and thunder intensity without changing server weather.")
            .build());
