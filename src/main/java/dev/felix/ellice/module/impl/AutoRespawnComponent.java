...
public final class AutoRespawnComponent extends ModuleSettingsService {
   public final ModuleSetting.Number delay = this.setting(
   ...
   private void updateState2() {
      ...
      if (minecraft.player != null && minecraft.level != null && !minecraft.player.isAlive() && !minecraft.level.getLevelData().isHardcore()) {
