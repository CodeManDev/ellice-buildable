  ...
  private final ModuleSetting.Number moduleNumber =
      this.setting(
          new ModuleSetting.Number("Height", 0.35F, 0.0F, 1.0F, 0.01F)
              .description(
                  "Controls the first-person flame position; lower values push the overlay farther"
                      + " down the screen."));
  private final ModuleSetting.Number moduleNumber2 =
      this.setting(
          new ModuleSetting.Number("Opacity", 0.75F, 0.0F, 0.9F, 0.01F)
              .description(
                  "Caps the first-person fire overlay alpha; 0 makes the flames invisible."));
