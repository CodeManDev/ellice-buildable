...
public final class ImplOpenPanelService extends ModuleSettingsService implements ModuleOperationHandler {
   public ImplOpenPanelService() {
      super(
         ModuleBuilderData.builder("Module Studio")
            .category(ModuleFeatureType.TOOLS)
            .description("Build your own modules with shapes, live data and connected logic blocks.")
            .build()
      );
   }
