...
public final class ModuleNameService {
   ...
   public int depth() {
      ...
      for (ModuleNameService moduleName = this.moduleNameService; moduleName != null; moduleName = moduleName.moduleNameService) {
         index++;
      }
   ...
   public List<String> path() {
      ...
      for (ModuleNameService moduleName = this; moduleName != null; moduleName = moduleName.moduleNameService) {
   ...
   ModuleNameService addChild(String currentText) {
      ...
      for (ModuleNameService moduleName : this.items) {
         if (moduleName.text.equalsIgnoreCase(nextText)) {
            throw new IllegalArgumentException("Setting category already exists below '" + this.qualifiedName() + "': " + nextText);
         }
      }
