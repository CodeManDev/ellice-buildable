...
public final class Render3dSourceWidthService {
   ...
   private Render3dSourceWidthService(int currentValue, int nextValue, float previousValue, int sourceValue, float targetValue, float inputValue, List<Render3dSourceWidthService.MipLevel> currentItems) {
   ...
   public static Render3dSourceWidthService create(int value, int currentValue, float nextValue, int previousValue) {
      if (value > 0 && currentValue > 0) {
         ...
         return new Render3dSourceWidthService(value, currentValue, nextValue, sourceValue, outputValue, resultValue, arrayList);
      } else {
