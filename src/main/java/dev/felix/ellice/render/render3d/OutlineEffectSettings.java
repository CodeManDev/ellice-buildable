...
public record OutlineEffectSettings(
   boolean enabled, int visibleColor, int occludedColor, float thicknessPixels, float softnessPixels, Render3dFeatureType visibility
) {
   ...
   public static final OutlineEffectSettings NONE = new OutlineEffectSettings(false, 0, 0, 0.5F, 0.0F, Render3dFeatureType.BOTH);
   ...
   public OutlineEffectSettings(int value, int currentValue, float nextValue, float previousValue, Render3dFeatureType render3dFeatureType) {
