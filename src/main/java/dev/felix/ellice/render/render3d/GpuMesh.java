...
public final class GpuMesh implements AutoCloseable {
  ...
  public static final RhiBlendStateService.VertexLayout VERTEX_LAYOUT =
  ...
  public void update(GeometryVertexCountService geometryVertexCount) {
    ...
    if (this.enabled
        ...
        && Arrays.equals(
            geometryVertexCount.indices(), this.geometryVertexCountService.indices())) {
      this.rhiOperationHandler.updateBuffer(
          this.bufferHandle, 0L, geometryVertexCount.vertexData());
  ...
  void ensureUploaded() {
    if (!this.enabled) {
      ...
      RhiBlendStateService.BufferHandle currentBufferHandle =
          RhiBlendStateService.BufferHandle.NONE;
      ...
      try {
        currentBufferHandle =
            this.rhiOperationHandler.createBuffer(
                ...
                this.geometryVertexCountService.vertexData());
