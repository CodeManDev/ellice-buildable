...
public record FireEffectSettings(
   ...
   public FireEffectSettings(
      ...
      this(value, currentValue, nextValue, previousValue, sourceValue, targetValue, inputValue, outputValue, resultValue, candidateValue, selectedValue, enabled, currentEnabled, outlineEffectSettings, kawaseBloomSettings, interferenceEffectSettings, render3dData, 0);
   }
   ...
   public FireEffectSettings(
      ...
      this(value, currentValue, nextValue, previousValue, sourceValue, targetValue, inputValue, outputValue, resultValue, candidateValue, selectedValue, enabled, currentEnabled, outlineEffectSettings, kawaseBloomSettings, interferenceEffectSettings, Render3dData.NONE);
   }
   ...
   public FireEffectSettings(
      ...
      this(value, currentValue, nextValue, previousValue, sourceValue, targetValue, inputValue, outputValue, resultValue, candidateValue, selectedValue, enabled, currentEnabled, outlineEffectSettings, kawaseBloomSettings, InterferenceEffectSettings.NONE);
   }
   ...
   public FireEffectSettings(
      ...
      this(value, currentValue, nextValue, previousValue, sourceValue, targetValue, inputValue, outputValue, resultValue, candidateValue, selectedValue, enabled, true, OutlineEffectSettings.NONE, KawaseBloomSettings.NONE);
   }

   public FireEffectSettings(
      int value, int currentValue, float nextValue, float previousValue, float sourceValue, float targetValue, float inputValue, float outputValue, float resultValue, float candidateValue, float selectedValue
   ) {
      this(value, currentValue, nextValue, previousValue, sourceValue, targetValue, inputValue, outputValue, resultValue, candidateValue, selectedValue, false);
   }
   ...
   public boolean hasFire() {
      return this.fireEnabled && this.intensity > 0.0F && (this.visibleOpacity > 0.0F || this.throughWallsOpacity > 0.0F);
   }
   ...
   public boolean renderable() {
      return this.hasFire() || this.hasOutline() || this.hasKawase() || this.hasInterference() || this.hasGlow() || this.hasEllice();
   }
