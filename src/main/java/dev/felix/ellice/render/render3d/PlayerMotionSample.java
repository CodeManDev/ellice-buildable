...
public record PlayerMotionSample(
    UUID playerId, float velocityX, float velocityY, float velocityZ, float damageAmount) {
  ...
  public PlayerMotionSample withDamage(float value) {
    return new PlayerMotionSample(
        this.playerId, this.velocityX, this.velocityY, this.velocityZ, value);
  }
