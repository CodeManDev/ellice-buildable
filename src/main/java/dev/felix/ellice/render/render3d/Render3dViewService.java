...
public final class Render3dViewService {
  ...
  public Render3dViewService(
    ...
    if (currentMatrix4f != null && nextMatrix4f != null && currentVector3d != null) {
      ...
      this.matrix4f6 =
          previousMatrix4f == null ? new Matrix4f(this.matrix4f3) : new Matrix4f(previousMatrix4f);
      this.vector3d = new Vector3d(currentVector3d);
      this.vector3d2 =
          nextVector3d == null ? new Vector3d(currentVector3d) : new Vector3d(nextVector3d);
