...
public final class MaterialErFactory {
  ...
  private MaterialErFactory(MaterialErFactory.Builder builder) {
    ...
    this.blendState =
        builder.blendState2 != null ? builder.blendState2 : createBlendState(builder.queue3);
    this.depthStencilState =
        builder.depthStencilState2 != null
            ? builder.depthStencilState2
            : createDepthStencilState(builder.queue3);
  ...
  public MaterialErFactory uniform(
  ...
  public MaterialErFactory texture(
  ...
  public MaterialErFactory.PipelineKey pipelineKey() {
    return new MaterialErFactory.PipelineKey(
        this.shaderData2, this.blendState, this.depthStencilState, this.rasterizerState);
  }
  ...
  private static RhiBlendStateService.DepthStencilState createDepthStencilState(
      MaterialErFactory.Queue queue) {
    return switch (queue) {
  ...
  public static final class Builder {
    ...
    private RhiBlendStateService.RasterizerState rasterizerState2 =
    ...
    public MaterialErFactory.Builder depthStencil(
    ...
    public MaterialErFactory.Builder rasterizer(
  ...
  public record Glow(int argb, float intensity, float radiusPixels) {
    ...
    public boolean enabled() {
      return this.intensity > 0.0F
          && this.radiusPixels > 0.0F
          && (this.argb >>> 24 & 0xFF) != 0
          && (this.argb & 16777215) != 0;
    }
