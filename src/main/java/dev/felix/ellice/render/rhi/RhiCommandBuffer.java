...
public interface RhiCommandBuffer {
   void beginRenderPass(RhiBlendStateService.FramebufferHandle framebufferHandle, float red, float green, float blue, float alpha);
   ...
   void bindIndexBuffer(RhiBlendStateService.BufferHandle bufferHandle, RhiBlendStateService.IndexType indexType);
   ...
   void bindTexture(RhiBlendStateService.TextureHandle textureHandle, RhiBlendStateService.SamplerHandle samplerHandle, int textureId);

   void setViewport(int x, int y, int width, int height);

   void setScissor(int x, int y, int width, int height);

   void setColorWriteMask(boolean enabled, boolean currentEnabled, boolean nextEnabled, boolean previousEnabled);
   ...
   default void blitFramebuffer(
      ...
      this.blitFramebuffer(framebufferHandle, currentFramebufferHandle, framebufferId, currentFramebufferId, nextFramebufferId, previousFramebufferId, sourceFramebufferId, targetFramebufferId, inputFramebufferId, outputFramebufferId, filterMode, RhiBlendStateService.FramebufferAspect.COLOR.bit);
   }
