...
public record RhiBuilderData(
  ...
  public static class Builder {
    ...
    private RhiBlendStateService.ShaderHandle shaderHandle2 =
        RhiBlendStateService.ShaderHandle.NONE;
    private RhiBlendStateService.ShaderHandle shaderHandle3 =
        RhiBlendStateService.ShaderHandle.NONE;
    ...
    private RhiBlendStateService.PrimitiveTopology primitiveTopology =
    ...
    public RhiBuilderData.Builder vertexLayout(
    ...
    public RhiBuilderData.Builder depthStencil(
        RhiBlendStateService.DepthStencilState depthStencilState) {
    ...
    public RhiBuilderData.Builder topology(
        RhiBlendStateService.PrimitiveTopology currentPrimitiveTopology) {
