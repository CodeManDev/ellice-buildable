...
{
    private final Map<Integer, PipelineState> fjb083tugn1v;
    private int f1033tkonaup;
    private final Map<Integer, Integer> fc1apd4plkbj;
    private final Map<Integer, Integer> f42q1xlw9mye;
    private final GlRenderer fhlhugm5lep;
    private long f74kmt4aa76p;
    ...
    public GlShaderFactory() {
        this.fjb083tugn1v = new HashMap<Integer, PipelineState>();
        this.fc1apd4plkbj = new HashMap<Integer, Integer>();
        this.f42q1xlw9mye = new HashMap<Integer, Integer>();
        this.fhlhugm5lep = new GlRenderer(this);
    }
    
    private static PixelUnpackState m288gwllrocx() {
        final PixelUnpackState pixelUnpackState = new PixelUnpackState(GL11.glGetInteger(35055), GL11.glGetInteger(3317), GL11.glGetInteger(3314), GL11.glGetInteger(3315), GL11.glGetInteger(3316));
    ...
    @Override
    public RhiBlendStateService.ShaderHandle createShader(final RhiBlendStateService.ShaderStage obj, final String s) {
        final int glCreateShader = GL20.glCreateShader(switch (obj) {
        ...
        if (GL20.glGetShaderi(glCreateShader, 35713) == 0) {
            ...
            throw new RuntimeException("Shader compilation failed (" + String.valueOf(obj) + "):\n" + glGetShaderInfoLog);
        }
    ...
    private static int miehdzqle563(final RhiBlendStateService.BufferAccess bufferAccess) {
    ...
    @Override
    public RhiBlendStateService.BufferHandle createBuffer(final long n, final int n2, final RhiBlendStateService.BufferAccess bufferAccess) {
        final int glGenBuffers = GL15.glGenBuffers();
        GL15.glBindBuffer(34962, glGenBuffers);
        GL15.glBufferData(34962, n, miehdzqle563(bufferAccess));
    ...
    @Override
    public RhiBlendStateService.BufferHandle createBuffer(final int n, final RhiBlendStateService.BufferAccess bufferAccess, final ByteBuffer byteBuffer) {
        final int glGenBuffers = GL15.glGenBuffers();
        GL15.glBindBuffer(34962, glGenBuffers);
        GL15.glBufferData(34962, byteBuffer, miehdzqle563(bufferAccess));
        GL15.glBindBuffer(34962, 0);
        return new RhiBlendStateService.BufferHandle(glGenBuffers);
    }
    ...
    @Override
    public RhiBlendStateService.BufferHandle createBuffer(final int n, final RhiBlendStateService.BufferAccess bufferAccess, final float[] src) {
        final FloatBuffer memAllocFloat = MemoryUtil.memAllocFloat(src.length);
        try {
            memAllocFloat.put(src).flip();
            final int glGenBuffers = GL15.glGenBuffers();
            GL15.glBindBuffer(34962, glGenBuffers);
            GL15.glBufferData(34962, memAllocFloat, miehdzqle563(bufferAccess));
            GL15.glBindBuffer(34962, 0);
            return new RhiBlendStateService.BufferHandle(glGenBuffers);
        }
        finally {
    ...
    @Override
    public void updateBuffer(final RhiBlendStateService.BufferHandle bufferHandle, final long n, final ByteBuffer byteBuffer) {
    ...
    @Override
    public void updateBuffer(final RhiBlendStateService.BufferHandle bufferHandle, final long n, final float[] array) {
        this.updateBuffer(bufferHandle, n, array, array.length);
    }
    
    @Override
    public void updateBuffer(final RhiBlendStateService.BufferHandle bufferHandle, final long n, final float[] src, final int length) {
        if (length <= 0) {
            return;
        }
    ...
    @Override
    public RhiBlendStateService.TextureHandle createTexture(final RhiBlendStateService.TextureDescriptor textureDescriptor) {
        ...
        try {
            ...
            GL11.glTexImage2D(3553, 0, glInternalFormat(textureDescriptor.format()), textureDescriptor.width(), textureDescriptor.height(), 0, glPixelFormat(textureDescriptor.format()), glPixelType(textureDescriptor.format()), (ByteBuffer)null);
            ...
            final int m9bnq6ocsne9 = m9bnq6ocsne9();
            if (m9bnq6ocsne9 != 0) {
                throw new IllegalStateException("Texture creation failed with GL error 0x" + Integer.toHexString(m9bnq6ocsne9));
            }
            b = true;
        }
        finally {
        ...
        this.fc1apd4plkbj.put(glGenTextures, glInternalFormat(textureDescriptor.format()));
        return new RhiBlendStateService.TextureHandle(glGenTextures);
    }
    
    @Override
    public RhiBlendStateService.TextureHandle createTexture(final RhiBlendStateService.TextureDescriptor textureDescriptor, final ByteBuffer byteBuffer) {
        final int glGetInteger = GL11.glGetInteger(32873);
        final int glGenTextures = GL11.glGenTextures();
        final PixelUnpackState m288gwllrocx = m288gwllrocx();
        boolean b = false;
        try {
            ...
            GL11.glBindTexture(3553, glGenTextures);
            GL11.glTexImage2D(3553, 0, glInternalFormat(textureDescriptor.format()), textureDescriptor.width(), textureDescriptor.height(), 0, glPixelFormat(textureDescriptor.format()), glPixelType(textureDescriptor.format()), byteBuffer);
            GL11.glTexParameteri(3553, 10241, glFilter(textureDescriptor.minFilter()));
            GL11.glTexParameteri(3553, 10240, glFilter(textureDescriptor.magFilter()));
            GL11.glTexParameteri(3553, 10242, glWrap(textureDescriptor.addressMode()));
            GL11.glTexParameteri(3553, 10243, glWrap(textureDescriptor.addressMode()));
            meyzdbkiogv8(textureDescriptor.minFilter());
            if (textureDescriptor.minFilter() == RhiBlendStateService.FilterMode.NEAREST_MIPMAP_LINEAR || textureDescriptor.minFilter() == RhiBlendStateService.FilterMode.LINEAR_MIPMAP_LINEAR) {
                GL30.glGenerateMipmap(3553);
            }
            final int m9bnq6ocsne9 = m9bnq6ocsne9();
            if (m9bnq6ocsne9 != 0) {
                throw new IllegalStateException("Texture upload failed with GL error 0x" + Integer.toHexString(m9bnq6ocsne9));
            }
            b = true;
        }
        finally {
    ...
    @Override
    public void updateTexture(final RhiBlendStateService.TextureHandle textureHandle, final int n, final int n2, final int n3, final int n4, final ByteBuffer byteBuffer) {
        final int glGetInteger = GL11.glGetInteger(32873);
        final PixelUnpackState m288gwllrocx = m288gwllrocx();
        try {
            ...
            GL11.glTexSubImage2D(3553, 0, n, n2, n3, n4, glPixelFormat(mh1t24qx5ubq), glPixelType(mh1t24qx5ubq), byteBuffer);
        }
        finally {
            GL11.glBindTexture(3553, glGetInteger);
            micx73bomiw7(m288gwllrocx);
    ...
    public void destroyTexture(final RhiBlendStateService.TextureHandle textureHandle) {
        if (textureHandle.valid()) {
            this.fc1apd4plkbj.remove(textureHandle.id());
    ...
    @Override
    public RhiBlendStateService.TextureDownload downloadTexture(final RhiBlendStateService.TextureHandle textureHandle) {
        ...
        try {
            ...
            if (glGetTexLevelParameteri <= 0 || glGetTexLevelParameteri2 <= 0 || glGetTexLevelParameteri > 4096 || glGetTexLevelParameteri2 > 4096) {
                return null;
            }
            ...
            try {
                ...
                if (m9bnq6ocsne9() == 0) {
                    textureDownload = new RhiBlendStateService.TextureDownload(memAlloc, glGetTexLevelParameteri, glGetTexLevelParameteri2);
                    memAlloc = null;
                }
            }
            finally {
    ...
    @Override
    public RhiBlendStateService.SamplerHandle createSampler(final RhiBlendStateService.SamplerDescriptor samplerDescriptor) {
    ...
    private static boolean mi6csq50rk48(final RhiBlendStateService.FilterMode filterMode) {
        return filterMode == RhiBlendStateService.FilterMode.NEAREST_MIPMAP_LINEAR || filterMode == RhiBlendStateService.FilterMode.LINEAR_MIPMAP_LINEAR;
    }
    ...
    @Override
    public RhiBlendStateService.FramebufferHandle createFramebuffer(final RhiBlendStateService.TextureHandle... array) {
        ...
        try {
            ...
            this.mjebj0e5smju();
            this.f42q1xlw9mye.put(glGenFramebuffers, array.length);
            b = true;
    ...
    @Override
    public RhiBlendStateService.FramebufferHandle createFramebuffer(final RhiBlendStateService.TextureHandle textureHandle, final RhiBlendStateService.TextureHandle textureHandle2) {
        final int glGetInteger = GL11.glGetInteger(36010);
        final int glGetInteger2 = GL11.glGetInteger(36006);
        final int glGenFramebuffers = GL30.glGenFramebuffers();
        boolean b = false;
        try {
            ...
            if (textureHandle2.valid()) {
                GL30.glFramebufferTexture2D(36160, manpk65hg463(this.fc1apd4plkbj.getOrDefault(textureHandle2.id(), 0)) ? 33306 : 36096, 3553, textureHandle2.id(), 0);
            }
            ...
            this.mjebj0e5smju();
            this.f42q1xlw9mye.put(glGenFramebuffers, valid);
            b = true;
            return new RhiBlendStateService.FramebufferHandle(glGenFramebuffers);
        }
        finally {
    ...
    public void destroyFramebuffer(final RhiBlendStateService.FramebufferHandle framebufferHandle) {
        if (framebufferHandle.valid() && framebufferHandle.id() != 0) {
            this.f42q1xlw9mye.remove(framebufferHandle.id());
            GL30.glDeleteFramebuffers(framebufferHandle.id());
        }
    }
    
    private void mjebj0e5smju() {
        final int glCheckFramebufferStatus = GL30.glCheckFramebufferStatus(36160);
        if (glCheckFramebufferStatus != 36053) {
            throw new IllegalStateException("Framebuffer incomplete: 0x" + Integer.toHexString(glCheckFramebufferStatus));
        }
    }
    
    @Override
    public RhiBlendStateService.DepthCopyTarget createCompatibleDepthCopyTarget(final RhiBlendStateService.FramebufferHandle framebufferHandle, final int i, final int j) {
        if (!framebufferHandle.valid() || i <= 0 || j <= 0) {
            return RhiBlendStateService.DepthCopyTarget.NONE;
        }
        final DepthAttachmentFormat m8h19nnnwebu = this.m8h19nnnwebu(framebufferHandle);
        if (m8h19nnnwebu == null) {
            CoreIsInitializedHandler.LOGGER.debug("No supported depth attachment on framebuffer {}", (Object)framebufferHandle.id());
            return RhiBlendStateService.DepthCopyTarget.NONE;
        }
        final int glGetInteger = GL11.glGetInteger(32873);
        ...
        try {
            ...
            GL11.glBindTexture(3553, glGenTextures);
            GL11.glTexImage2D(3553, 0, m8h19nnnwebu.internalFormat(), i, j, 0, m8h19nnnwebu.pixelFormat(), m8h19nnnwebu.pixelType(), (ByteBuffer)null);
            ...
            GL30.glBindFramebuffer(36160, glGenFramebuffers);
            GL30.glFramebufferTexture2D(36160, m8h19nnnwebu.attachmentPoint(), 3553, glGenTextures, 0);
            GL11.glDrawBuffer(0);
            GL11.glReadBuffer(0);
            final int glCheckFramebufferStatus = GL30.glCheckFramebufferStatus(36160);
            final int m9bnq6ocsne9 = m9bnq6ocsne9();
            if (glCheckFramebufferStatus != 36053 || m9bnq6ocsne9 != 0) {
                CoreIsInitializedHandler.LOGGER.warn("Could not create compatible depth-copy target (source={}, format=0x{}, status=0x{}, error=0x{})", new Object[] { framebufferHandle.id(), Integer.toHexString(m8h19nnnwebu.internalFormat()), Integer.toHexString(glCheckFramebufferStatus), Integer.toHexString(m9bnq6ocsne9) });
                return RhiBlendStateService.DepthCopyTarget.NONE;
            }
            this.fc1apd4plkbj.put(glGenTextures, m8h19nnnwebu.internalFormat());
            this.f42q1xlw9mye.put(glGenFramebuffers, 0);
            CoreIsInitializedHandler.LOGGER.debug("Created depth-copy target {}x{} with GL format 0x{}", new Object[] { i, j, Integer.toHexString(m8h19nnnwebu.internalFormat()) });
            b = true;
            return new RhiBlendStateService.DepthCopyTarget(new RhiBlendStateService.TextureHandle(glGenTextures), new RhiBlendStateService.FramebufferHandle(glGenFramebuffers));
        }
        finally {
            GL11.glBindTexture(3553, glGetInteger);
            micx73bomiw7(m288gwllrocx);
    ...
    @Override
    public boolean blitFramebufferDepth(final RhiBlendStateService.FramebufferHandle framebufferHandle, final RhiBlendStateService.FramebufferHandle framebufferHandle2, final int n, final int n2, final int n3, final int n4, final int n5, final int n6, final int n7, final int n8) {
        if (!framebufferHandle.valid() || !framebufferHandle2.valid()) {
            return false;
        }
        final DepthAttachmentFormat m8h19nnnwebu = this.m8h19nnnwebu(framebufferHandle);
        final DepthAttachmentFormat m8h19nnnwebu2 = this.m8h19nnnwebu(framebufferHandle2);
        if (m8h19nnnwebu == null || m8h19nnnwebu2 == null || m8h19nnnwebu.internalFormat() != m8h19nnnwebu2.internalFormat()) {
            return false;
        }
        final int glGetInteger = GL11.glGetInteger(36010);
        final int glGetInteger2 = GL11.glGetInteger(36006);
    ...
    private DepthAttachmentFormat m8h19nnnwebu(final RhiBlendStateService.FramebufferHandle framebufferHandle) {
        final int glGetInteger = GL11.glGetInteger(36010);
        try {
            ...
            final int glGetFramebufferAttachmentParameteri = GL30.glGetFramebufferAttachmentParameteri(36008, n, 33302);
            final int glGetFramebufferAttachmentParameteri2 = GL30.glGetFramebufferAttachmentParameteri(36008, n, 33297);
            final int n2 = (framebufferHandle.id() == 0) ? 6146 : 36128;
            final AttachmentIdentity mdyg5oigw3ek2 = mdyg5oigw3ek(n2);
            int glGetFramebufferAttachmentParameteri3 = 0;
            if (mdyg5oigw3ek2.present() && mdyg5oigw3ek2.equals(mdyg5oigw3ek)) {
                glGetFramebufferAttachmentParameteri3 = GL30.glGetFramebufferAttachmentParameteri(36008, n2, 33303);
            }
            final DepthAttachmentFormat mgwulfudeph8 = mgwulfudeph8(glGetFramebufferAttachmentParameteri, glGetFramebufferAttachmentParameteri3, glGetFramebufferAttachmentParameteri2);
            return (m9bnq6ocsne9() == 0) ? mgwulfudeph8 : null;
        }
        finally {
            GL30.glBindFramebuffer(36008, glGetInteger);
        }
    ...
    private static AttachmentIdentity mdyg5oigw3ek(final int n) {
        final int glGetFramebufferAttachmentParameteri = GL30.glGetFramebufferAttachmentParameteri(36008, n, 36048);
        if (glGetFramebufferAttachmentParameteri == 0) {
            return new AttachmentIdentity(glGetFramebufferAttachmentParameteri, 0);
        }
        return new AttachmentIdentity(glGetFramebufferAttachmentParameteri, GL30.glGetFramebufferAttachmentParameteri(36008, n, 36049));
    }
    ...
    private void m5lulpwgwxe(final String s) {
        ...
        if (this.f74kmt4aa76p == 0L || nanoTime - this.f74kmt4aa76p >= 5000000000L) {
            this.f74kmt4aa76p = nanoTime;
            CoreIsInitializedHandler.LOGGER.warn("Cleared pre-existing GL error 0x{} before {}; it predates the current ellice depth operation", (Object)Integer.toHexString(m9bnq6ocsne9), (Object)s);
        }
    }
    
    private static int m9bnq6ocsne9() {
        int n = 0;
        int glGetError;
    ...
    public RhiBlendStateService.PipelineHandle createPipeline(final RhiBuilderData rhiBuilderData) {
        ...
        if (rhiBuilderData.vertexLayout() != null) {
            ...
            final RhiBlendStateService.VertexAttribute[] attributes = rhiBuilderData.vertexLayout().attributes();
            for (int length = attributes.length, i = 0; i < length; ++i) {
                GL20.glEnableVertexAttribArray(attributes[i].location());
            }
            GL30.glBindVertexArray(0);
        }
        final int j = this.f1033tkonaup++;
        if (j < 0) {
            GL20.glDeleteProgram(glCreateProgram);
        ...
        this.fjb083tugn1v.put(j, new PipelineState(glCreateProgram, glGenVertexArrays, rhiBuilderData.vertexLayout(), rhiBuilderData.blendState(), rhiBuilderData.depthStencilState(), rhiBuilderData.rasterizerState(), rhiBuilderData.topology()));
    ...
    public void destroyPipeline(final RhiBlendStateService.PipelineHandle pipelineHandle) {
        ...
        final PipelineState pipelineState = this.fjb083tugn1v.remove(pipelineHandle.id());
    ...
    PipelineState getPipeline(final int i) {
        final PipelineState pipelineState = this.fjb083tugn1v.get(i);
        if (pipelineState == null) {
    ...
    int getFramebufferColorAttachmentCount(final int i) {
        return this.f42q1xlw9mye.getOrDefault(i, -1);
    }
    
    private RhiBlendStateService.TextureFormat mh1t24qx5ubq(final int i) {
        final int intValue = this.fc1apd4plkbj.getOrDefault(i, 0);
        if (intValue == 33321) {
    ...
    record DepthAttachmentFormat(int internalFormat, int pixelFormat, int pixelType, int attachmentPoint) {}
    ...
    record PipelineState(int program, int vao, RhiBlendStateService.VertexLayout layout, RhiBlendStateService.BlendState blend, RhiBlendStateService.DepthStencilState depthStencil, RhiBlendStateService.RasterizerState rasterizer, RhiBlendStateService.PrimitiveTopology topology) {}
}
