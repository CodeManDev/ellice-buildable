...
public enum FriendsMode {
  ...
  PROJECTILE_PREDICTOR(
      ...
      "Exclude from target intel and enemy warnings. Real projectile collisions stay visible.",
      false);
  ...
  private static FriendsMode[] $values() {
    return new FriendsMode[] {
      KILL_AURA, BOW_AIMBOT, AUTO_LAVA, BACKTRACK, TICK_BASE, ESP, NAMETAGS, PROJECTILE_PREDICTOR
    };
  }
}
